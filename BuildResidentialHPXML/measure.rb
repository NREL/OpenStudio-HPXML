...
class BuildResidentialHPXML < OpenStudio::Measure::ModelMeasure
  ...
  def arguments(model) # rubocop:disable Lint/UnusedMethodArgument
    ...
    arg = OpenStudio::Measure::OSArgument::makeDoubleArgument('electric_panel_load_water_heater_power_rating', false)
    arg.setDisplayName('Electric Panel: Water Heater Power Rating')
    ...
    arg.setDescription("Specifies the panel load water heater voltage. If not provided, the OS-HPXML default (see <a href='#{docs_base_url}#service-feeders'>Service Feeders</a>) is used.")
    arg.setUnits('V')
    args << arg

    arg = OpenStudio::Measure::OSArgument::makeBoolArgument('electric_panel_load_water_heater_new_load', false)
    arg.setDisplayName('Electric Panel: Water Heater Addition')
    arg.setDescription("Whether the water heater is a new panel load addition to an existing service panel. If not provided, the OS-HPXML default (see <a href='#{docs_base_url}#service-feeders'>Service Feeders</a>) is used.")
    args << arg

    arg = OpenStudio::Measure::OSArgument::makeDoubleArgument('electric_panel_load_clothes_dryer_power_rating', false)
    arg.setDisplayName('Electric Panel: Clothes Dryer Power Rating')
    arg.setDescription("Specifies the panel load power rating. Only applies to electric clothes dryer. If not provided, the OS-HPXML default (see <a href='#{docs_base_url}#service-feeders'>Service Feeders</a>) is used.")
    arg.setUnits('W')
    args << arg
    ...
    arg.setDescription("Specifies the panel load voltage. If not provided, the OS-HPXML default (see <a href='#{docs_base_url}#service-feeders'>Service Feeders</a>) is used.")
    arg.setUnits('V')
    args << arg

    arg = OpenStudio::Measure::OSArgument::makeBoolArgument('electric_panel_load_clothes_dryer_new_load', false)
    arg.setDisplayName('Electric Panel: Clothes Dryer Addition')
    arg.setDescription("Whether the clothes dryer is a new panel load addition to an existing service panel. If not provided, the OS-HPXML default (see <a href='#{docs_base_url}#service-feeders'>Service Feeders</a>) is used.")
    args << arg
    ...
    arg = OpenStudio::Measure::OSArgument::makeDoubleArgument('electric_panel_load_cooking_range_power_rating', false)
    arg.setDisplayName('Electric Panel: Cooking Range/Oven Power Rating')
    ...
    arg.setDescription("Specifies the panel load cooking range/oven voltage. If not provided, the OS-HPXML default (see <a href='#{docs_base_url}#service-feeders'>Service Feeders</a>) is used.")
    arg.setUnits('V')
    args << arg

    arg = OpenStudio::Measure::OSArgument::makeBoolArgument('electric_panel_load_cooking_range_new_load', false)
    arg.setDisplayName('Electric Panel: Cooking Range/Oven Addition')
    arg.setDescription("Whether the cooking range is a new panel load addition to an existing service panel. If not provided, the OS-HPXML default (see <a href='#{docs_base_url}#service-feeders'>Service Feeders</a>) is used.")
    args << arg
    ...
    arg = OpenStudio::Measure::OSArgument::makeDoubleArgument('electric_panel_load_pool_heater_power_rating', false)
    arg.setDisplayName('Electric Panel: Pool Heater Power Rating')
    ...
    arg = OpenStudio::Measure::OSArgument::makeBoolArgument('electric_panel_load_pool_heater_new_load', false)
    arg.setDisplayName('Electric Panel: Pool Heater Addition')
    arg.setDescription("Whether the pool heater is a new panel load addition to an existing service panel. If not provided, the OS-HPXML default (see <a href='#{docs_base_url}#service-feeders'>Service Feeders</a>) is used.")
    args << arg
    ...
    arg = OpenStudio::Measure::OSArgument::makeDoubleArgument('electric_panel_load_permanent_spa_heater_power_rating', false)
    arg.setDisplayName('Electric Panel: Permanent Spa Heater Power Rating')
    ...
    arg = OpenStudio::Measure::OSArgument::makeBoolArgument('electric_panel_load_permanent_spa_heater_new_load', false)
    arg.setDisplayName('Electric Panel: Permanent Spa Heater Addition')
    arg.setDescription("Whether the spa heater is a new panel load addition to an existing service panel. If not provided, the OS-HPXML default (see <a href='#{docs_base_url}#service-feeders'>Service Feeders</a>) is used.")
    args << arg
  ...
  def self.set_electric_panel(hpxml_bldg, args)
    ...
    hpxml_bldg.water_heating_systems.each do |water_heating_system|
      ...
      service_feeders.add(id: "ServiceFeeder#{service_feeders.size + 1}",
                          ...
                          power: args[:electric_panel_load_water_heater_power_rating],
                          is_new_load: args[:electric_panel_load_water_heater_new_load],
                          component_idrefs: [water_heating_system.id])
    end
    ...
    hpxml_bldg.clothes_dryers.each do |clothes_dryer|
      ...
      service_feeders.add(id: "ServiceFeeder#{service_feeders.size + 1}",
                          ...
                          power: args[:electric_panel_load_clothes_dryer_power_rating],
                          is_new_load: args[:electric_panel_load_clothes_dryer_new_load],
                          component_idrefs: [clothes_dryer.id])
    end
    ...
    hpxml_bldg.cooking_ranges.each do |cooking_range|
      ...
      service_feeders.add(id: "ServiceFeeder#{service_feeders.size + 1}",
                          ...
                          power: args[:electric_panel_load_cooking_range_power_rating],
                          is_new_load: args[:electric_panel_load_cooking_range_new_load],
                          component_idrefs: [cooking_range.id])
    end
    ...
    hpxml_bldg.permanent_spas.each do |permanent_spa|
      service_feeders.add(id: "ServiceFeeder#{service_feeders.size + 1}",
                          ...
                          is_new_load: args[:permanent_spa_pump_panel_load_new_load],
      ...
      service_feeders.add(id: "ServiceFeeder#{service_feeders.size + 1}",
                          ...
                          is_new_load: args[:permanent_spa_heater_panel_load_new_load],
    ...
    hpxml_bldg.pools.each do |pool|
      ...
      service_feeders.add(id: "ServiceFeeder#{service_feeders.size + 1}",
                          ...
                          power: args[:electric_panel_load_pool_heater_power_rating],
                          is_new_load: args[:electric_panel_load_pool_heater_new_load],
