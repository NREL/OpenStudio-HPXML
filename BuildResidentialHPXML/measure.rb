...
class BuildResidentialHPXML < OpenStudio::Measure::ModelMeasure
  ...
  def arguments(model) # rubocop:disable Lint/UnusedMethodArgument
    ...
    arg = OpenStudio::Measure::OSArgument::makeDoubleArgument('hvac_distribution_heating_airflow_rate', false)
    ...
    arg = OpenStudio::Measure::OSArgument::makeDoubleArgument('hvac_distribution_cooling_airflow_rate', false)
  ...
  def self.set_hvac_distribution(hpxml_bldg, args)
    ...
    hpxml_bldg.hvac_distributions.each do |hvac_distribution|
      ...
      hvac_distribution.hvac_systems.each do |hvac_system|
        ...
        if args[:hvac_distribution_cooling_airflow_rate].is_initialized
          cooling_airflow_cfm = args[:hvac_distribution_cooling_airflow_rate].get
        end
