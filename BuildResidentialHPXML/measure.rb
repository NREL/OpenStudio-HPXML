...
class BuildResidentialHPXML < OpenStudio::Measure::ModelMeasure
  ...
  def arguments(model) # rubocop:disable Lint/UnusedMethodArgument
    ...
    arg.setDescription("Enter a date like 'Jan 1 - Dec 31'. If not provided, the OS-HPXML default (see [HPXML Simulation Control](#{docs_base_url}#hpxml-simulation-control)) is used.")
    args << arg
    ...
    arg.setUnits('year')
    arg.setDescription("This numeric field should contain the calendar year that determines the start day of week. If you are running simulations using AMY weather files, the value entered for calendar year will not be used; it will be overridden by the actual year found in the AMY weather file. If not provided, the OS-HPXML default (see [HPXML Simulation Control](#{docs_base_url}#hpxml-simulation-control)) is used.")
    args << arg
    ...
    arg.setDescription("Whether to use daylight saving. If not provided, the OS-HPXML default (see [HPXML Building Site](#{docs_base_url}#hpxml-building-site)) is used.")
    args << arg
    ...
    arg.setDescription("Enter a date like 'Mar 15 - Dec 15'. If not provided, the OS-HPXML default (see [HPXML Building Site](#{docs_base_url}#hpxml-building-site)) is used.")
    args << arg
    ...
    arg.setDescription("Affects the transient calculation of indoor air temperatures. If not provided, the OS-HPXML default (see [HPXML Simulation Control](#{docs_base_url}#hpxml-simulation-control)) is used.")
    args << arg
    ...
    arg.setDescription("The type of site. If not provided, the OS-HPXML default (see [HPXML Site](#{docs_base_url}#hpxml-site)) is used.")
    args << arg
    ...
    arg.setDescription("Presence of nearby buildings, trees, obstructions for infiltration model. If not provided, the OS-HPXML default (see [HPXML Site](#{docs_base_url}#hpxml-site)) is used.")
    args << arg
    ...
    arg.setDescription("Conductivity of the ground soil. If not provided, the OS-HPXML default (see [HPXML Site](#{docs_base_url}#hpxml-site)) is used.")
    ...
    arg.setUnits('#')
    arg.setDescription("The number of bathrooms in the unit. If not provided, the OS-HPXML default (see [HPXML Building Construction](#{docs_base_url}#hpxml-building-construction)) is used.")
    args << arg
    ...
    arg.setUnits('ft')
    arg.setDescription("The height of the neighboring building to the front. If not provided, the OS-HPXML default (see [HPXML Site](#{docs_base_url}#hpxml-site)) is used.")
    args << arg

    arg = OpenStudio::Measure::OSArgument::makeDoubleArgument('neighbor_back_height', false)
    arg.setDisplayName('Neighbor: Back Height')
    arg.setUnits('ft')
    arg.setDescription("The height of the neighboring building to the back. If not provided, the OS-HPXML default (see [HPXML Site](#{docs_base_url}#hpxml-site)) is used.")
    args << arg

    arg = OpenStudio::Measure::OSArgument::makeDoubleArgument('neighbor_left_height', false)
    arg.setDisplayName('Neighbor: Left Height')
    arg.setUnits('ft')
    arg.setDescription("The height of the neighboring building to the left. If not provided, the OS-HPXML default (see [HPXML Site](#{docs_base_url}#hpxml-site)) is used.")
    args << arg

    arg = OpenStudio::Measure::OSArgument::makeDoubleArgument('neighbor_right_height', false)
    arg.setDisplayName('Neighbor: Right Height')
    arg.setUnits('ft')
    arg.setDescription("The height of the neighboring building to the right. If not provided, the OS-HPXML default (see [HPXML Site](#{docs_base_url}#hpxml-site)) is used.")
    args << arg
    ...
    arg.setDescription("The material type of the foundation wall. If not provided, the OS-HPXML default (see [HPXML Foundation Walls](#{docs_base_url}#hpxml-foundation-walls)) is used.")
    args << arg
    ...
    arg.setUnits('in')
    arg.setDescription("The thickness of the foundation wall. If not provided, the OS-HPXML default (see [HPXML Foundation Walls](#{docs_base_url}#hpxml-foundation-walls)) is used.")
    args << arg
    ...
    arg.setUnits('ft')
    arg.setDescription("The distance from the top of the foundation wall to the top of the foundation wall insulation. Only applies to basements/crawlspaces. If not provided, the OS-HPXML default (see [HPXML Foundation Walls](#{docs_base_url}#hpxml-foundation-walls)) is used.")
    args << arg
    ...
    arg.setUnits('ft')
    arg.setDescription("The distance from the top of the foundation wall to the bottom of the foundation wall insulation. Only applies to basements/crawlspaces. If not provided, the OS-HPXML default (see [HPXML Foundation Walls](#{docs_base_url}#hpxml-foundation-walls)) is used.")
    args << arg
    ...
    arg.setUnits('in')
    arg.setDescription("The thickness of the slab. Zero can be entered if there is a dirt floor instead of a slab. If not provided, the OS-HPXML default (see [HPXML Slabs](#{docs_base_url}#hpxml-slabs)) is used.")
    args << arg

    arg = OpenStudio::Measure::OSArgument::makeDoubleArgument('slab_carpet_fraction', false)
    arg.setDisplayName('Slab: Carpet Fraction')
    arg.setUnits('Frac')
    arg.setDescription("Fraction of the slab floor area that is carpeted. If not provided, the OS-HPXML default (see [HPXML Slabs](#{docs_base_url}#hpxml-slabs)) is used.")
    args << arg

    arg = OpenStudio::Measure::OSArgument::makeDoubleArgument('slab_carpet_r', false)
    arg.setDisplayName('Slab: Carpet R-value')
    arg.setUnits('h-ft^2-R/Btu')
    arg.setDescription("R-value of the slab carpet. If not provided, the OS-HPXML default (see [HPXML Slabs](#{docs_base_url}#hpxml-slabs)) is used.")
    args << arg
    ...
    arg.setDescription("The material type of the roof. If not provided, the OS-HPXML default (see [HPXML Roofs](#{docs_base_url}#hpxml-roofs)) is used.")
    args << arg
    ...
    arg.setDescription("The color of the roof. If not provided, the OS-HPXML default (see [HPXML Roofs](#{docs_base_url}#hpxml-roofs)) is used.")
    args << arg
    ...
    arg.setDescription("The grade of the radiant barrier. If not provided, the OS-HPXML default (see [HPXML Roofs](#{docs_base_url}#hpxml-roofs)) is used.")
    args << arg
    ...
    arg.setDescription("The siding type of the walls. Also applies to rim joists. If not provided, the OS-HPXML default (see [HPXML Walls](#{docs_base_url}#hpxml-walls)) is used.")
    args << arg

    arg = OpenStudio::Measure::OSArgument::makeChoiceArgument('wall_color', color_choices, false)
    arg.setDisplayName('Wall: Color')
    arg.setDescription("The color of the walls. Also applies to rim joists. If not provided, the OS-HPXML default (see [HPXML Walls](#{docs_base_url}#hpxml-walls)) is used.")
    args << arg
    ...
    arg.setUnits('Frac')
    arg.setDescription("Fraction of windows that are operable. If not provided, the OS-HPXML default (see [HPXML Windows](#{docs_base_url}#hpxml-windows)) is used.")
    args << arg
    ...
    arg.setDescription("For operable windows, the number of days/week that windows can be opened by occupants for natural ventilation. If not provided, the OS-HPXML default (see [HPXML Windows](#{docs_base_url}#hpxml-windows)) is used.")
    args << arg
    ...
    arg.setUnits('Frac')
    arg.setDescription("Interior shading coefficient for the winter season. 1.0 indicates no reduction in solar gain, 0.85 indicates 15% reduction, etc. If not provided, the OS-HPXML default (see [HPXML Windows](#{docs_base_url}#hpxml-windows)) is used.")
    args << arg
    ...
    arg.setUnits('Frac')
    arg.setDescription("Interior shading coefficient for the summer season. 1.0 indicates no reduction in solar gain, 0.85 indicates 15% reduction, etc. If not provided, the OS-HPXML default (see [HPXML Windows](#{docs_base_url}#hpxml-windows)) is used.")
    args << arg
    ...
    arg.setUnits('Frac')
    arg.setDescription("Exterior shading coefficient for the winter season. 1.0 indicates no reduction in solar gain, 0.85 indicates 15% reduction, etc. If not provided, the OS-HPXML default (see [HPXML Windows](#{docs_base_url}#hpxml-windows)) is used.")
    args << arg
    ...
    arg.setUnits('Frac')
    arg.setDescription("Exterior shading coefficient for the summer season. 1.0 indicates no reduction in solar gain, 0.85 indicates 15% reduction, etc. If not provided, the OS-HPXML default (see [HPXML Windows](#{docs_base_url}#hpxml-windows)) is used.")
    args << arg
    ...
    arg.setDescription("Enter a date like 'May 1 - Sep 30'. Defines the summer season for purposes of shading coefficients; the rest of the year is assumed to be winter. If not provided, the OS-HPXML default (see [HPXML Windows](#{docs_base_url}#hpxml-windows)) is used.")
    args << arg
    ...
    arg.setDescription("Presence of flue or chimney with combustion air from conditioned space; used for infiltration model. If not provided, the OS-HPXML default (see [Flue or Chimney](#{docs_base_url}#flue-or-chimney)) is used.")
    args << arg
    ...
    arg.setDescription("The output heating capacity of the heating system. If not provided, the OS-HPXML autosized default (see [HPXML Heating Systems](#{docs_base_url}#hpxml-heating-systems)) is used.")
    arg.setUnits('Btu/hr')
    args << arg
    ...
    arg.setDescription("The compressor type of the cooling system. Only applies to #{HPXML::HVACTypeCentralAirConditioner}. If not provided, the OS-HPXML default (see [Central Air Conditioner](#{docs_base_url}#central-air-conditioner)) is used.")
    args << arg
    ...
    arg.setDescription("The sensible heat fraction of the cooling system. Ignored for #{HPXML::HVACTypeEvaporativeCooler}. If not provided, the OS-HPXML default (see [Central Air Conditioner](#{docs_base_url}#central-air-conditioner), [Room Air Conditioner](#{docs_base_url}#room-air-conditioner), [Packaged Terminal Air Conditioner](#{docs_base_url}#packaged-terminal-air-conditioner), [Mini-Split Air Conditioner](#{docs_base_url}#mini-split-air-conditioner)) is used.")
    arg.setUnits('Frac')
    args << arg
    ...
    arg.setDescription("The output cooling capacity of the cooling system. If not provided, the OS-HPXML autosized default (see [Central Air Conditioner](#{docs_base_url}#central-air-conditioner), [Room Air Conditioner](#{docs_base_url}#room-air-conditioner), [Packaged Terminal Air Conditioner](#{docs_base_url}#packaged-terminal-air-conditioner), [Evaporative Cooler](#{docs_base_url}#evaporative-cooler), [Mini-Split Air Conditioner](#{docs_base_url}#mini-split-air-conditioner)) is used.")
    arg.setUnits('Btu/hr')
    args << arg
    ...
    arg.setDescription("The output heating capacity of the heating system integrated into cooling system. If not provided, the OS-HPXML autosized default (see [Room Air Conditioner](#{docs_base_url}#room-air-conditioner), [Packaged Terminal Air Conditioner](#{docs_base_url}#packaged-terminal-air-conditioner)) is used. Only used for #{HPXML::HVACTypeRoomAirConditioner} and #{HPXML::HVACTypePTAC}.")
    arg.setUnits('Btu/hr')
    args << arg
    ...
    arg.setDescription("The compressor type of the heat pump. Only applies to #{HPXML::HVACTypeHeatPumpAirToAir}. If not provided, the OS-HPXML default (see [Air-to-Air Heat Pump](#{docs_base_url}#air-to-air-heat-pump)) is used.")
    args << arg
    ...
    arg.setDescription("The sensible heat fraction of the heat pump. If not provided, the OS-HPXML default (see [Air-to-Air Heat Pump](#{docs_base_url}#air-to-air-heat-pump), [Mini-Split Heat Pump](#{docs_base_url}#mini-split-heat-pump), [Packaged Terminal Heat Pump](#{docs_base_url}#packaged-terminal-heat-pump), [Room Air Conditioner w/ Reverse Cycle](#{docs_base_url}#room-air-conditioner-w-reverse-cycle), [Ground-to-Air Heat Pump](#{docs_base_url}#ground-to-air-heat-pump)) is used.")
    arg.setUnits('Frac')
    args << arg
    ...
    arg.setDescription("The output heating capacity of the heat pump. If not provided, the OS-HPXML autosized default (see [Air-to-Air Heat Pump](#{docs_base_url}#air-to-air-heat-pump), [Mini-Split Heat Pump](#{docs_base_url}#mini-split-heat-pump), [Packaged Terminal Heat Pump](#{docs_base_url}#packaged-terminal-heat-pump), [Room Air Conditioner w/ Reverse Cycle](#{docs_base_url}#room-air-conditioner-w-reverse-cycle), [Ground-to-Air Heat Pump](#{docs_base_url}#ground-to-air-heat-pump)) is used.")
    arg.setUnits('Btu/hr')
    args << arg
    ...
    arg.setDescription("The output heating capacity of the heat pump at a user-specified temperature (e.g., 17F or 5F) divided by the above nominal heating capacity. Applies to all heat pump types except #{HPXML::HVACTypeHeatPumpGroundToAir}. If not provided, the OS-HPXML default (see [Air-to-Air Heat Pump](#{docs_base_url}#air-to-air-heat-pump), [Mini-Split Heat Pump](#{docs_base_url}#mini-split-heat-pump), [Packaged Terminal Heat Pump](#{docs_base_url}#packaged-terminal-heat-pump), [Room Air Conditioner w/ Reverse Cycle](#{docs_base_url}#room-air-conditioner-w-reverse-cycle)) is used.")
    arg.setUnits('Frac')
    args << arg
    ...
    arg.setDescription("The output cooling capacity of the heat pump. If not provided, the OS-HPXML autosized default (see [Air-to-Air Heat Pump](#{docs_base_url}#air-to-air-heat-pump), [Mini-Split Heat Pump](#{docs_base_url}#mini-split-heat-pump), [Packaged Terminal Heat Pump](#{docs_base_url}#packaged-terminal-heat-pump), [Room Air Conditioner w/ Reverse Cycle](#{docs_base_url}#room-air-conditioner-w-reverse-cycle), [Ground-to-Air Heat Pump](#{docs_base_url}#ground-to-air-heat-pump)) is used.")
    arg.setUnits('Btu/hr')
    args << arg
    ...
    arg.setDescription("The backup output heating capacity of the heat pump. If not provided, the OS-HPXML autosized default (see [Backup](#{docs_base_url}#backup)) is used. Only applies if Backup Type is '#{HPXML::HeatPumpBackupTypeIntegrated}'.")
    arg.setUnits('Btu/hr')
    args << arg
    ...
    arg.setDescription("The temperature above which the heat pump backup system is disabled. If both this and Compressor Lockout Temperature are provided and use the same value, it essentially defines a switchover temperature (for, e.g., a dual-fuel heat pump). Applies for both Backup Type of '#{HPXML::HeatPumpBackupTypeIntegrated}' and '#{HPXML::HeatPumpBackupTypeSeparate}'. If not provided, the OS-HPXML default (see [Backup](#{docs_base_url}#backup)) is used.")
    arg.setUnits('deg-F')
    args << arg
    ...
    arg.setDescription("The auto-sizing methodology to use when the heat pump capacity is not provided. If not provided, the OS-HPXML default (see [HPXML HVAC Sizing Control](#{docs_base_url}#hpxml-hvac-sizing-control)) is used.")
    args << arg
    ...
    arg.setDescription("The output heating capacity of the second heating system. If not provided, the OS-HPXML autosized default (see [HPXML Heating Systems](#{docs_base_url}#hpxml-heating-systems)) is used.")
    arg.setUnits('Btu/hr')
    args << arg
    ...
    arg.setDescription("Enter a date like 'Nov 1 - Jun 30'. If not provided, the OS-HPXML default (see [HPXML HVAC Control](#{docs_base_url}#hpxml-hvac-control)) is used. Can also provide '#{HPXML::BuildingAmerica}' to use automatic seasons from the Building America House Simulation Protocols.")
    args << arg
    ...
    arg.setDescription("Enter a date like 'Jun 1 - Oct 31'. If not provided, the OS-HPXML default (see [HPXML HVAC Control](#{docs_base_url}#hpxml-hvac-control)) is used. Can also provide '#{HPXML::BuildingAmerica}' to use automatic seasons from the Building America House Simulation Protocols.")
    args << arg
    ...
    arg.setDescription("The location of the supply ducts. If not provided, the OS-HPXML default (see [Air Distribution](#{docs_base_url}#air-distribution)) is used.")
    args << arg
    ...
    arg.setDescription("The supply ducts surface area in the given location. If neither Surface Area nor Area Fraction provided, the OS-HPXML default (see [Air Distribution](#{docs_base_url}#air-distribution)) is used.")
    arg.setUnits('ft^2')
    args << arg
    ...
    arg.setDescription("The fraction of supply ducts surface area in the given location. Only used if Surface Area is not provided. If the fraction is less than 1, the remaining duct area is assumed to be in conditioned space. If neither Surface Area nor Area Fraction provided, the OS-HPXML default (see [Air Distribution](#{docs_base_url}#air-distribution)) is used.")
    arg.setUnits('frac')
    args << arg
    ...
    arg.setDescription("The location of the return ducts. If not provided, the OS-HPXML default (see [Air Distribution](#{docs_base_url}#air-distribution)) is used.")
    args << arg
    ...
    arg.setDescription("The return ducts surface area in the given location. If neither Surface Area nor Area Fraction provided, the OS-HPXML default (see [Air Distribution](#{docs_base_url}#air-distribution)) is used.")
    arg.setUnits('ft^2')
    args << arg
    ...
    arg.setDescription("The number of return registers of the ducts. Only used to calculate default return duct surface area. If not provided, the OS-HPXML default (see [Air Distribution](#{docs_base_url}#air-distribution)) is used.")
    arg.setUnits('#')
    args << arg
    ...
    arg.setDescription("The flow rate of the mechanical ventilation. If not provided, the OS-HPXML default (see [Whole Ventilation Fan](#{docs_base_url}#whole-ventilation-fan)) is used.")
    arg.setUnits('CFM')
    args << arg
    ...
    arg.setDescription("The hours in operation of the mechanical ventilation. If not provided, the OS-HPXML default (see [Whole Ventilation Fan](#{docs_base_url}#whole-ventilation-fan)) is used.")
    ...
    arg.setDescription("The fan power of the mechanical ventilation. If not provided, the OS-HPXML default (see [Whole Ventilation Fan](#{docs_base_url}#whole-ventilation-fan)) is used.")
    arg.setUnits('W')
    args << arg
    ...
    arg.setDescription("The quantity of the kitchen fans. If not provided, the OS-HPXML default (see [Local Ventilation Fan](#{docs_base_url}#local-ventilation-fan)) is used.")
    arg.setUnits('#')
    args << arg
    ...
    arg.setDescription("The flow rate of the kitchen fan. If not provided, the OS-HPXML default (see [Local Ventilation Fan](#{docs_base_url}#local-ventilation-fan)) is used.")
    arg.setUnits('CFM')
    args << arg
    ...
    arg.setDescription("The hours in operation of the kitchen fan. If not provided, the OS-HPXML default (see [Local Ventilation Fan](#{docs_base_url}#local-ventilation-fan)) is used.")
    arg.setUnits('hrs/day')
    args << arg

    arg = OpenStudio::Measure::OSArgument::makeDoubleArgument('kitchen_fans_power', false)
    arg.setDisplayName('Kitchen Fans: Fan Power')
    arg.setDescription("The fan power of the kitchen fan. If not provided, the OS-HPXML default (see [Local Ventilation Fan](#{docs_base_url}#local-ventilation-fan)) is used.")
    arg.setUnits('W')
    args << arg
    ...
    arg.setDescription("The start hour of the kitchen fan. If not provided, the OS-HPXML default (see [Local Ventilation Fan](#{docs_base_url}#local-ventilation-fan)) is used.")
    arg.setUnits('hr')
    args << arg
    ...
    arg.setDescription("The quantity of the bathroom fans. If not provided, the OS-HPXML default (see [Local Ventilation Fan](#{docs_base_url}#local-ventilation-fan)) is used.")
    arg.setUnits('#')
    args << arg
    ...
    arg.setDescription("The flow rate of the bathroom fans. If not provided, the OS-HPXML default (see [Local Ventilation Fan](#{docs_base_url}#local-ventilation-fan)) is used.")
    arg.setUnits('CFM')
    args << arg
    ...
    arg.setDescription("The hours in operation of the bathroom fans. If not provided, the OS-HPXML default (see [Local Ventilation Fan](#{docs_base_url}#local-ventilation-fan)) is used.")
    arg.setUnits('hrs/day')
    args << arg

    arg = OpenStudio::Measure::OSArgument::makeDoubleArgument('bathroom_fans_power', false)
    arg.setDisplayName('Bathroom Fans: Fan Power')
    arg.setDescription("The fan power of the bathroom fans. If not provided, the OS-HPXML default (see [Local Ventilation Fan](#{docs_base_url}#local-ventilation-fan)) is used.")
    arg.setUnits('W')
    args << arg
    ...
    arg.setDescription("The start hour of the bathroom fans. If not provided, the OS-HPXML default (see [Local Ventilation Fan](#{docs_base_url}#local-ventilation-fan)) is used.")
    arg.setUnits('hr')
    args << arg
    ...
    arg.setDescription("The flow rate of the whole house fan. If not provided, the OS-HPXML default (see [Whole House Fan](#{docs_base_url}#whole-house-fan)) is used.")
    arg.setUnits('CFM')
    args << arg
    ...
    arg.setDescription("The fan power of the whole house fan. If not provided, the OS-HPXML default (see [Whole House Fan](#{docs_base_url}#whole-house-fan)) is used.")
    arg.setUnits('W')
    args << arg
    ...
    arg.setDescription("The location of water heater. If not provided, the OS-HPXML default (see [HPXML Water Heating Systems](#{docs_base_url}#hpxml-water-heating-systems)) is used.")
    args << arg
    ...
    arg.setDescription("Nominal volume of water heater tank. Only applies to #{HPXML::WaterHeaterTypeStorage}, #{HPXML::WaterHeaterTypeHeatPump}, and #{HPXML::WaterHeaterTypeCombiStorage}. If not provided, the OS-HPXML default (see [Conventional Storage](#{docs_base_url}#conventional-storage), [Heat Pump](#{docs_base_url}#heat-pump), [Combi Boiler w/ Storage](#{docs_base_url}#combi-boiler-w-storage)) is used.")
    arg.setUnits('gal')
    args << arg
    ...
    arg.setDescription("The usage of the water heater. Only applies if Efficiency Type is UniformEnergyFactor and Type is not #{HPXML::WaterHeaterTypeTankless}. Does not apply to space-heating boilers. If not provided, the OS-HPXML default (see [Conventional Storage](#{docs_base_url}#conventional-storage), [Heat Pump](#{docs_base_url}#heat-pump)) is used.")
    args << arg
    ...
    arg.setDescription("Ratio of energy delivered to water heater to the energy content of the fuel consumed by the water heater. Only used for non-electric storage water heaters. If not provided, the OS-HPXML default (see [Conventional Storage](#{docs_base_url}#conventional-storage)) is used.")
    arg.setUnits('Frac')
    args << arg
    ...
    arg.setDescription("Heating capacity. Only applies to #{HPXML::WaterHeaterTypeStorage}. If not provided, the OS-HPXML default (see [Conventional Storage](#{docs_base_url}#conventional-storage)) is used.")
    arg.setUnits('Btu/hr')
    args << arg
    ...
    arg.setDescription("The standby loss of water heater. Only applies to space-heating boilers. If not provided, the OS-HPXML default (see [Combi Boiler w/ Storage](#{docs_base_url}#combi-boiler-w-storage)) is used.")
    ...
    arg.setDescription("The setpoint temperature of water heater. If not provided, the OS-HPXML default (see [HPXML Water Heating Systems](#{docs_base_url}#hpxml-water-heating-systems)) is used.")
    arg.setUnits('deg-F')
    args << arg
    ...
    arg.setDescription("Type of tank model to use. The '#{HPXML::WaterHeaterTankModelTypeStratified}' tank generally provide more accurate results, but may significantly increase run time. Applies only to #{HPXML::WaterHeaterTypeStorage}. If not provided, the OS-HPXML default (see [Conventional Storage](#{docs_base_url}#conventional-storage)) is used.")
    args << arg
    ...
    arg.setUnits('ft')
    arg.setDescription("If the distribution system is #{HPXML::DHWDistTypeStandard}, the length of the piping. If not provided, the OS-HPXML default (see [Standard](#{docs_base_url}#standard)) is used.")
    args << arg
    ...
    arg.setUnits('ft')
    arg.setDescription("If the distribution system is #{HPXML::DHWDistTypeRecirc}, the length of the recirculation piping. If not provided, the OS-HPXML default (see [Recirculation](#{docs_base_url}#recirculation)) is used.")
    args << arg
    ...
    arg.setUnits('ft')
    arg.setDescription("If the distribution system is #{HPXML::DHWDistTypeRecirc}, the length of the recirculation branch piping. If not provided, the OS-HPXML default (see [Recirculation](#{docs_base_url}#recirculation)) is used.")
    args << arg
    ...
    arg.setUnits('W')
    arg.setDescription("If the distribution system is #{HPXML::DHWDistTypeRecirc}, the recirculation pump power. If not provided, the OS-HPXML default (see [Recirculation](#{docs_base_url}#recirculation)) is used.")
    args << arg
    ...
    arg.setUnits('h-ft^2-R/Btu')
    arg.setDescription("Nominal R-value of the pipe insulation. If not provided, the OS-HPXML default (see [HPXML Hot Water Distribution](#{docs_base_url}#hpxml-hot-water-distribution)) is used.")
    args << arg
    ...
    arg.setDescription("Multiplier on the hot water usage that can reflect, e.g., high/low usage occupants. If not provided, the OS-HPXML default (see [HPXML Water Fixtures](#{docs_base_url}#hpxml-water-fixtures)) is used.")
    args << arg
    ...
    arg.setUnits('gal')
    arg.setDescription("The storage volume of the solar thermal system. If not provided, the OS-HPXML default (see [Detailed Inputs](#{docs_base_url}#detailed-inputs)) is used.")
    args << arg
    ...
    arg.setDescription("Module type of the PV system. If not provided, the OS-HPXML default (see [HPXML Photovoltaics](#{docs_base_url}#hpxml-photovoltaics)) is used.")
    args << arg
    ...
    arg.setDescription("Location of the PV system. If not provided, the OS-HPXML default (see [HPXML Photovoltaics](#{docs_base_url}#hpxml-photovoltaics)) is used.")
    args << arg
    ...
    arg.setDescription("Type of tracking for the PV system. If not provided, the OS-HPXML default (see [HPXML Photovoltaics](#{docs_base_url}#hpxml-photovoltaics)) is used.")
    args << arg
    ...
    arg.setUnits('Frac')
    arg.setDescription("Inverter efficiency of the PV system. If there are two PV systems, this will apply to both. If not provided, the OS-HPXML default (see [HPXML Photovoltaics](#{docs_base_url}#hpxml-photovoltaics)) is used.")
    args << arg
    ...
    arg.setUnits('Frac')
    arg.setDescription("System losses fraction of the PV system. If there are two PV systems, this will apply to both. If not provided, the OS-HPXML default (see [HPXML Photovoltaics](#{docs_base_url}#hpxml-photovoltaics)) is used.")
    args << arg
    ...
    arg.setDescription("Module type of the second PV system. If not provided, the OS-HPXML default (see [HPXML Photovoltaics](#{docs_base_url}#hpxml-photovoltaics)) is used.")
    args << arg
    ...
    arg.setDescription("Location of the second PV system. If not provided, the OS-HPXML default (see [HPXML Photovoltaics](#{docs_base_url}#hpxml-photovoltaics)) is used.")
    args << arg
    ...
    arg.setDescription("Type of tracking for the second PV system. If not provided, the OS-HPXML default (see [HPXML Photovoltaics](#{docs_base_url}#hpxml-photovoltaics)) is used.")
    args << arg
    ...
    arg.setDescription("The space type for the lithium ion battery location. If not provided, the OS-HPXML default (see [HPXML Batteries](#{docs_base_url}#hpxml-batteries)) is used.")
    args << arg

    arg = OpenStudio::Measure::OSArgument::makeDoubleArgument('battery_power', false)
    arg.setDisplayName('Battery: Rated Power Output')
    arg.setDescription("The rated power output of the lithium ion battery. If not provided, the OS-HPXML default (see [HPXML Batteries](#{docs_base_url}#hpxml-batteries)) is used.")
    arg.setUnits('W')
    args << arg

    arg = OpenStudio::Measure::OSArgument::makeDoubleArgument('battery_capacity', false)
    arg.setDisplayName('Battery: Nominal Capacity')
    arg.setDescription("The nominal capacity of the lithium ion battery. If not provided, the OS-HPXML default (see [HPXML Batteries](#{docs_base_url}#hpxml-batteries)) is used.")
    arg.setUnits('kWh')
    args << arg
    ...
    arg.setDescription("The usable capacity of the lithium ion battery. If not provided, the OS-HPXML default (see [HPXML Batteries](#{docs_base_url}#hpxml-batteries)) is used.")
    arg.setUnits('kWh')
    args << arg
    ...
    arg.setDescription("The round trip efficiency of the lithium ion battery. If not provided, the OS-HPXML default (see [HPXML Batteries](#{docs_base_url}#hpxml-batteries)) is used.")
    arg.setUnits('Frac')
    args << arg
    ...
    arg.setDescription("Multiplier on the lighting energy usage (interior) that can reflect, e.g., high/low usage occupants. If not provided, the OS-HPXML default (see [HPXML Lighting](#{docs_base_url}#hpxml-lighting)) is used.")
    args << arg
    ...
    arg.setDescription("Multiplier on the lighting energy usage (exterior) that can reflect, e.g., high/low usage occupants. If not provided, the OS-HPXML default (see [HPXML Lighting](#{docs_base_url}#hpxml-lighting)) is used.")
    args << arg
    ...
    arg.setDescription("Multiplier on the lighting energy usage (garage) that can reflect, e.g., high/low usage occupants. If not provided, the OS-HPXML default (see [HPXML Lighting](#{docs_base_url}#hpxml-lighting)) is used.")
    args << arg
    ...
    arg.setDescription("The daily energy consumption for holiday lighting (exterior). If not provided, the OS-HPXML default (see [HPXML Lighting](#{docs_base_url}#hpxml-lighting)) is used.")
    args << arg
    ...
    arg.setDescription("Enter a date like 'Nov 25 - Jan 5'. If not provided, the OS-HPXML default (see [HPXML Lighting](#{docs_base_url}#hpxml-lighting)) is used.")
    args << arg
    ...
    arg.setDescription("The space type for the clothes washer location. If not provided, the OS-HPXML default (see [HPXML Clothes Washer](#{docs_base_url}#hpxml-clothes-washer)) is used.")
    args << arg
    ...
    arg.setDescription("The efficiency of the clothes washer. If not provided, the OS-HPXML default (see [HPXML Clothes Washer](#{docs_base_url}#hpxml-clothes-washer)) is used.")
    args << arg
    ...
    arg.setUnits('$')
    arg.setDescription("The annual cost of using the system under test conditions. Input is obtained from the EnergyGuide label. If not provided, the OS-HPXML default (see [HPXML Clothes Washer](#{docs_base_url}#hpxml-clothes-washer)) is used.")
    args << arg
    ...
    arg.setUnits('cyc/wk')
    arg.setDescription("The clothes washer loads per week. If not provided, the OS-HPXML default (see [HPXML Clothes Washer](#{docs_base_url}#hpxml-clothes-washer)) is used.")
    args << arg
    ...
    arg.setUnits('ft^3')
    arg.setDescription("Volume of the washer drum. Obtained from the EnergyStar website or the manufacturer's literature. If not provided, the OS-HPXML default (see [HPXML Clothes Washer](#{docs_base_url}#hpxml-clothes-washer)) is used.")
    args << arg
    ...
    arg.setDescription("Multiplier on the clothes washer energy and hot water usage that can reflect, e.g., high/low usage occupants. If not provided, the OS-HPXML default (see [HPXML Clothes Washer](#{docs_base_url}#hpxml-clothes-washer)) is used.")
    args << arg
    ...
    arg.setDescription("The space type for the clothes dryer location. If not provided, the OS-HPXML default (see [HPXML Clothes Dryer](#{docs_base_url}#hpxml-clothes-dryer)) is used.")
    args << arg
    ...
    arg.setUnits('lb/kWh')
    arg.setDescription("The efficiency of the clothes dryer. If not provided, the OS-HPXML default (see [HPXML Clothes Dryer](#{docs_base_url}#hpxml-clothes-dryer)) is used.")
    args << arg
    ...
    arg.setDescription("The exhaust flow rate of the vented clothes dryer. If not provided, the OS-HPXML default (see [HPXML Clothes Dryer](#{docs_base_url}#hpxml-clothes-dryer)) is used.")
    arg.setUnits('CFM')
    args << arg
    ...
    arg.setDescription("Multiplier on the clothes dryer energy usage that can reflect, e.g., high/low usage occupants. If not provided, the OS-HPXML default (see [HPXML Clothes Dryer](#{docs_base_url}#hpxml-clothes-dryer)) is used.")
    args << arg
    ...
    arg.setDescription("The space type for the dishwasher location. If not provided, the OS-HPXML default (see [HPXML Dishwasher](#{docs_base_url}#hpxml-dishwasher)) is used.")
    args << arg
    ...
    arg.setDescription("The efficiency of the dishwasher. If not provided, the OS-HPXML default (see [HPXML Dishwasher](#{docs_base_url}#hpxml-dishwasher)) is used.")
    args << arg
    ...
    arg.setUnits('$/kWh')
    arg.setDescription("The label electric rate of the dishwasher. If not provided, the OS-HPXML default (see [HPXML Dishwasher](#{docs_base_url}#hpxml-dishwasher)) is used.")
    args << arg
    ...
    arg.setUnits('$/therm')
    arg.setDescription("The label gas rate of the dishwasher. If not provided, the OS-HPXML default (see [HPXML Dishwasher](#{docs_base_url}#hpxml-dishwasher)) is used.")
    args << arg
    ...
    arg.setUnits('$')
    arg.setDescription("The label annual gas cost of the dishwasher. If not provided, the OS-HPXML default (see [HPXML Dishwasher](#{docs_base_url}#hpxml-dishwasher)) is used.")
    args << arg
    ...
    arg.setUnits('cyc/wk')
    arg.setDescription("The dishwasher loads per week. If not provided, the OS-HPXML default (see [HPXML Dishwasher](#{docs_base_url}#hpxml-dishwasher)) is used.")
    args << arg
    ...
    arg.setUnits('#')
    arg.setDescription("The number of place settings for the unit. Data obtained from manufacturer's literature. If not provided, the OS-HPXML default (see [HPXML Dishwasher](#{docs_base_url}#hpxml-dishwasher)) is used.")
    args << arg
    ...
    arg.setDescription("Multiplier on the dishwasher energy usage that can reflect, e.g., high/low usage occupants. If not provided, the OS-HPXML default (see [HPXML Dishwasher](#{docs_base_url}#hpxml-dishwasher)) is used.")
    args << arg
    ...
    arg.setDescription("The space type for the refrigerator location. If not provided, the OS-HPXML default (see [HPXML Refrigerators](#{docs_base_url}#hpxml-refrigerators)) is used.")
    args << arg
    ...
    arg.setUnits('kWh/yr')
    arg.setDescription("The EnergyGuide rated annual energy consumption for a refrigerator. If not provided, the OS-HPXML default (see [HPXML Refrigerators](#{docs_base_url}#hpxml-refrigerators)) is used.")
    args << arg
    ...
    arg.setDescription("Multiplier on the refrigerator energy usage that can reflect, e.g., high/low usage occupants. If not provided, the OS-HPXML default (see [HPXML Refrigerators](#{docs_base_url}#hpxml-refrigerators)) is used.")
    args << arg
    ...
    arg.setDescription("The space type for the extra refrigerator location. If not provided, the OS-HPXML default (see [HPXML Refrigerators](#{docs_base_url}#hpxml-refrigerators)) is used.")
    args << arg
    ...
    arg.setUnits('kWh/yr')
    arg.setDescription("The EnergyGuide rated annual energy consumption for an extra rrefrigerator. If not provided, the OS-HPXML default (see [HPXML Refrigerators](#{docs_base_url}#hpxml-refrigerators)) is used.")
    args << arg
    ...
    arg.setDescription("Multiplier on the extra refrigerator energy usage that can reflect, e.g., high/low usage occupants. If not provided, the OS-HPXML default (see [HPXML Refrigerators](#{docs_base_url}#hpxml-refrigerators)) is used.")
    args << arg
    ...
    arg.setDescription("The space type for the freezer location. If not provided, the OS-HPXML default (see [HPXML Freezers](#{docs_base_url}#hpxml-freezers)) is used.")
    args << arg
    ...
    arg.setUnits('kWh/yr')
    arg.setDescription("The EnergyGuide rated annual energy consumption for a freezer. If not provided, the OS-HPXML default (see [HPXML Freezers](#{docs_base_url}#hpxml-freezers)) is used.")
    args << arg
    ...
    arg.setDescription("Multiplier on the freezer energy usage that can reflect, e.g., high/low usage occupants. If not provided, the OS-HPXML default (see [HPXML Freezers](#{docs_base_url}#hpxml-freezers)) is used.")
    args << arg
    ...
    arg.setDescription("The space type for the cooking range/oven location. If not provided, the OS-HPXML default (see [HPXML Cooking Range/Oven](#{docs_base_url}#hpxml-cooking-range-oven)) is used.")
    args << arg
    ...
    arg.setDescription("Whether the cooking range is induction. If not provided, the OS-HPXML default (see [HPXML Cooking Range/Oven](#{docs_base_url}#hpxml-cooking-range-oven)) is used.")
    args << arg
    ...
    arg.setDescription("Whether the oven is convection. If not provided, the OS-HPXML default (see [HPXML Cooking Range/Oven](#{docs_base_url}#hpxml-cooking-range-oven)) is used.")
    args << arg
    ...
    arg.setDescription("Multiplier on the cooking range/oven energy usage that can reflect, e.g., high/low usage occupants. If not provided, the OS-HPXML default (see [HPXML Cooking Range/Oven](#{docs_base_url}#hpxml-cooking-range-oven)) is used.")
    args << arg
    ...
    arg.setUnits('CFM/W')
    arg.setDescription("The efficiency rating of the ceiling fan(s) at medium speed. If not provided, the OS-HPXML default (see [HPXML Ceiling Fans](#{docs_base_url}#hpxml-ceiling-fans)) is used.")
    args << arg

    arg = OpenStudio::Measure::OSArgument::makeIntegerArgument('ceiling_fan_quantity', false)
    arg.setDisplayName('Ceiling Fan: Quantity')
    arg.setUnits('#')
    arg.setDescription("Total number of ceiling fans. If not provided, the OS-HPXML default (see [HPXML Ceiling Fans](#{docs_base_url}#hpxml-ceiling-fans)) is used.")
    args << arg
    ...
    arg.setUnits('deg-F')
    arg.setDescription("The cooling setpoint temperature offset during months when the ceiling fans are operating. Only applies if ceiling fan quantity is greater than zero. If not provided, the OS-HPXML default (see [HPXML Ceiling Fans](#{docs_base_url}#hpxml-ceiling-fans)) is used.")
    args << arg
    ...
    arg.setDescription("The annual energy consumption of the television plug loads. If not provided, the OS-HPXML default (see [HPXML Plug Loads](#{docs_base_url}#hpxml-plug-loads)) is used.")
    arg.setUnits('kWh/yr')
    args << arg
    ...
    arg.setDescription("Multiplier on the television energy usage that can reflect, e.g., high/low usage occupants. If not provided, the OS-HPXML default (see [HPXML Plug Loads](#{docs_base_url}#hpxml-plug-loads)) is used.")
    args << arg
    ...
    arg.setDescription("The annual energy consumption of the other residual plug loads. If not provided, the OS-HPXML default (see [HPXML Plug Loads](#{docs_base_url}#hpxml-plug-loads)) is used.")
    arg.setUnits('kWh/yr')
    args << arg
    ...
    arg.setDescription("Fraction of other residual plug loads' internal gains that are sensible. If not provided, the OS-HPXML default (see [HPXML Plug Loads](#{docs_base_url}#hpxml-plug-loads)) is used.")
    arg.setUnits('Frac')
    args << arg
    ...
    arg.setDescription("Fraction of other residual plug loads' internal gains that are latent. If not provided, the OS-HPXML default (see [HPXML Plug Loads](#{docs_base_url}#hpxml-plug-loads)) is used.")
    arg.setUnits('Frac')
    args << arg
    ...
    arg.setDescription("Multiplier on the other energy usage that can reflect, e.g., high/low usage occupants. If not provided, the OS-HPXML default (see [HPXML Plug Loads](#{docs_base_url}#hpxml-plug-loads)) is used.")
    args << arg
    ...
    arg.setDescription("The annual energy consumption of the well pump plug loads. If not provided, the OS-HPXML default (see [HPXML Plug Loads](#{docs_base_url}#hpxml-plug-loads)) is used.")
    arg.setUnits('kWh/yr')
    args << arg
    ...
    arg.setDescription("Multiplier on the well pump energy usage that can reflect, e.g., high/low usage occupants. If not provided, the OS-HPXML default (see [HPXML Plug Loads](#{docs_base_url}#hpxml-plug-loads)) is used.")
    args << arg
    ...
    arg.setDescription("The annual energy consumption of the electric vehicle plug loads. If not provided, the OS-HPXML default (see [HPXML Plug Loads](#{docs_base_url}#hpxml-plug-loads)) is used.")
    arg.setUnits('kWh/yr')
    args << arg
    ...
    arg.setDescription("Multiplier on the electric vehicle energy usage that can reflect, e.g., high/low usage occupants. If not provided, the OS-HPXML default (see [HPXML Plug Loads](#{docs_base_url}#hpxml-plug-loads)) is used.")
    args << arg
    ...
    arg.setDescription("The annual energy consumption of the fuel loads grill. If not provided, the OS-HPXML default (see [HPXML Fuel Loads](#{docs_base_url}#hpxml-fuel-loads)) is used.")
    ...
    arg.setDescription("Multiplier on the fuel loads grill energy usage that can reflect, e.g., high/low usage occupants. If not provided, the OS-HPXML default (see [HPXML Fuel Loads](#{docs_base_url}#hpxml-fuel-loads)) is used.")
    args << arg
    ...
    arg.setDescription("The annual energy consumption of the fuel loads lighting. If not provided, the OS-HPXML default (see [HPXML Fuel Loads](#{docs_base_url}#hpxml-fuel-loads))is used.")
    arg.setUnits('therm/yr')
    args << arg
    ...
    arg.setDescription("Multiplier on the fuel loads lighting energy usage that can reflect, e.g., high/low usage occupants. If not provided, the OS-HPXML default (see [HPXML Fuel Loads](#{docs_base_url}#hpxml-fuel-loads)) is used.")
    args << arg
    ...
    arg.setDescription("The annual energy consumption of the fuel loads fireplace. If not provided, the OS-HPXML default (see [HPXML Fuel Loads](#{docs_base_url}#hpxml-fuel-loads)) is used.")
    arg.setUnits('therm/yr')
    args << arg
    ...
    arg.setDescription("Fraction of fireplace residual fuel loads' internal gains that are sensible. If not provided, the OS-HPXML default (see [HPXML Fuel Loads](#{docs_base_url}#hpxml-fuel-loads)) is used.")
    arg.setUnits('Frac')
    args << arg
    ...
    arg.setDescription("Fraction of fireplace residual fuel loads' internal gains that are latent. If not provided, the OS-HPXML default (see [HPXML Fuel Loads](#{docs_base_url}#hpxml-fuel-loads)) is used.")
    arg.setUnits('Frac')
    args << arg
    ...
    arg.setDescription("Multiplier on the fuel loads fireplace energy usage that can reflect, e.g., high/low usage occupants. If not provided, the OS-HPXML default (see [HPXML Fuel Loads](#{docs_base_url}#hpxml-fuel-loads)) is used.")
    args << arg
    ...
    arg.setDescription("The annual energy consumption of the pool pump. If not provided, the OS-HPXML default (see [Pool Pump](#{docs_base_url}#pool-pump)) is used.")
    arg.setUnits('kWh/yr')
    args << arg
    ...
    arg.setDescription("Multiplier on the pool pump energy usage that can reflect, e.g., high/low usage occupants. If not provided, the OS-HPXML default (see [Pool Pump](#{docs_base_url}#pool-pump)) is used.")
    args << arg
    ...
    arg.setDescription("The annual energy consumption of the #{HPXML::HeaterTypeElectricResistance} pool heater. If not provided, the OS-HPXML default (see [Pool Heater](#{docs_base_url}#pool-heater)) is used.")
    arg.setUnits('kWh/yr')
    args << arg
    ...
    arg.setDescription("The annual energy consumption of the #{HPXML::HeaterTypeGas} pool heater. If not provided, the OS-HPXML default (see [Pool Heater](#{docs_base_url}#pool-heater)) is used.")
    arg.setUnits('therm/yr')
    args << arg
    ...
    arg.setDescription("Multiplier on the pool heater energy usage that can reflect, e.g., high/low usage occupants. If not provided, the OS-HPXML default (see [Pool Heater](#{docs_base_url}#pool-heater)) is used.")
    args << arg
    ...
    arg.setDescription("The annual energy consumption of the permanent spa pump. If not provided, the OS-HPXML default (see [Permanent Spa Pump](#{docs_base_url}#permanent-spa-pump)) is used.")
    arg.setUnits('kWh/yr')
    args << arg
    ...
    arg.setDescription("Multiplier on the permanent spa pump energy usage that can reflect, e.g., high/low usage occupants. If not provided, the OS-HPXML default (see [Permanent Spa Pump](#{docs_base_url}#permanent-spa-pump)) is used.")
    args << arg
    ...
    arg.setDescription("The annual energy consumption of the #{HPXML::HeaterTypeElectricResistance} permanent spa heater. If not provided, the OS-HPXML default (see [Permanent Spa Heater](#{docs_base_url}#permanent-spa-heater)) is used.")
    arg.setUnits('kWh/yr')
    args << arg
    ...
    arg.setDescription("The annual energy consumption of the #{HPXML::HeaterTypeGas} permanent spa heater. If not provided, the OS-HPXML default (see [Permanent Spa Heater](#{docs_base_url}#permanent-spa-heater)) is used.")
    arg.setUnits('therm/yr')
    args << arg
    ...
    arg.setDescription("Multiplier on the permanent spa heater energy usage that can reflect, e.g., high/low usage occupants. If not provided, the OS-HPXML default (see [Permanent Spa Heater](#{docs_base_url}#permanent-spa-heater)) is used.")
    args << arg
