...
class BuildResidentialHPXMLTest < Minitest::Test
  ...
  def _set_measure_argument_values(hpxml_file, args)
    ...
    if ['error-heating-system-and-heat-pump.xml'].include? hpxml_file
      ...
      args['heating_perf_data_outdoor_temperatures'] = '47.0'
    elsif ['error-heating-perf-data-not-all-same-size.xml'].include? hpxml_file
      args['heating_perf_data_outdoor_temperatures'] = '47.0'
      args['heating_perf_data_minimum_capacities'] = '10000, 4200'
      args['heating_perf_data_maximum_capacities'] = '36000, 24800'
      args['heating_perf_data_minimum_cops'] = '4.73, 1.84'
      args['heating_perf_data_maximum_cops'] = '3.44, 2.66'
    elsif ['error-cooling-perf-data-not-all-specified.xml'].include? hpxml_file
      args['cooling_perf_data_outdoor_temperatures'] = '95.0'
    elsif ['error-cooling-perf-data-not-all-same-size.xml'].include? hpxml_file
      args['cooling_perf_data_outdoor_temperatures'] = '95.0'
      args['cooling_perf_data_minimum_capacities'] = '11700, 13200'
      args['cooling_perf_data_maximum_capacities'] = '36000, 40000'
      args['cooling_perf_data_minimum_cops'] = '4.47, 6.34'
      args['cooling_perf_data_maximum_cops'] = '2.71, 3.53'
