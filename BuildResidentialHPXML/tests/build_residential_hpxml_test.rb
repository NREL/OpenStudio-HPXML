...
class BuildResidentialHPXMLTest < MiniTest::Test
  def test_workflows
    ...
    expected_errors = {
      ...
      'error-sfd-conditioned-basement-zero-foundation-height.xml' => 'Selected a non-slab or non-above apartment foundation type with a height of zero.',
      ...
      'error-mf-bottom-crawlspace-zero-foundation-height.xml' => 'Selected a non-slab or non-above apartment foundation type with a height of zero.',
    ...
    expected_warnings = {
      ...
      'warning-sfd-slab-non-zero-foundation-height.xml' => 'Selected slab or above apartment foundation type with a non-zero foundation height. Assuming foundation height is zero.',
      'warning-mf-bottom-slab-non-zero-foundation-height.xml' => 'Selected slab or above apartment foundation type with a non-zero foundation height. Assuming foundation height is zero.',
      'warning-slab-non-zero-foundation-height-above-grade.xml' => 'Selected a slab foundation type with a non-zero height above grade.',
      ...
      'warning-vented-crawlspace-with-wall-and-ceiling-insulation.xml' => 'Selected unconditioned basement/crawlspace foundation type with wall and ceiling insulation. Assuming FIXME.',
      'warning-unvented-crawlspace-with-wall-and-ceiling-insulation.xml' => 'Selected unconditioned basement/crawlspace foundation type with wall and ceiling insulation. Assuming FIXME.',
      'warning-unconditioned-basement-with-wall-and-ceiling-insulation.xml' => 'Selected unconditioned basement/crawlspace foundation type with wall and ceiling insulation. Assuming FIXME.',
      'warning-vented-attic-with-floor-and-roof-insulation.xml' => 'Selected unconditioned attic type with wall and roof insulation. Assuming FIXME.',
      'warning-unvented-attic-with-floor-and-roof-insulation.xml' => 'Selected unconditioned attic type with wall and roof insulation. Assuming FIXME.',
      'warning-conditioned-basement-with-ceiling-insulation.xml' => 'Selected conditioned basement with ceiling insulation. Assuming FIXME.',
      'warning-conditioned-attic-with-floor-insulation.xml' => 'Selected conditioned attic with floor insulation. Assuming FIXME.',
