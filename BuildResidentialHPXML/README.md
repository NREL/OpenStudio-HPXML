...
The type of the second heating system. If a heat pump is specified and the backup type is 'separate', this heating system represents 'separate' backup heating. A 'Furnace' as 'separate' backup to a ducted heat pump is not supported.
