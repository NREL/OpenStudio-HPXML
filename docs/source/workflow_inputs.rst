...
If operable windows are defined, the availability of natural ventilation and the desired setpoint is entered in ``/HPXML/SoftwareInfo/extension``.
  ...
  ``NaturalVentilationSetpoints``                float     F                       No                  The intended setpoint to be met by natural ventilation
  =============================================  ========  =========  ===========  ========  ========  ========================================================
