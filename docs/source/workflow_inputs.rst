...
If a storm window is specified, additional information is entered in ``StormWindow``.
  ...
  .. [#] GlassType choices are "clear" or "low-e".
         ...
         Note that a storm window is not allowed for a window with U-factor lower than 0.3 due to the loss of accuracy by extrapolating.
...
If a storm window is specified, additional information is entered in ``StormWindow``.
  ...
  .. [#] GlassType choices are "clear" or "low-e".
         ...
         Note that a storm window is not allowed for a skylight with U-factor lower than 0.3 due to the loss of accuracy by extrapolating.
