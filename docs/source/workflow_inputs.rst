...
For simple utility rate structures, inputs can be entered using a fixed charge and a marginal rate.
  ...
  .. [#] If MarginalRate not provided, defaults to state or national average based on EIA SEDS data from 2023 that can be found at ``ReportUtilityBills/resources/simple_rates/pr_all_update.csv``.
