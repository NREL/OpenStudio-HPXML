...
class SimulationOutputReport < OpenStudio::Measure::ReportingMeasure
  ...
  def setup_outputs
    ...
    @end_uses = {
      ...
      [FT::Gas, EUT::Grill] => EndUse.new(meter: "#{Constants.ObjectNameMiscGasGrill}:InteriorEquipment:Gas"),
      [FT::Gas, EUT::Lighting] => EndUse.new(meter: "#{Constants.ObjectNameMiscGasLighting}:InteriorEquipment:Gas"),
      [FT::Gas, EUT::Fireplace] => EndUse.new(meter: "#{Constants.ObjectNameMiscGasFireplace}:InteriorEquipment:Gas"),
