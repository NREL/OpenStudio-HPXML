...
class SimulationOutputReport < OpenStudio::Measure::ReportingMeasure
  ...
  def add_object_output_variables(timeseries_frequency)
    hvac_output_vars = [OutputVars.SpaceHeatingElectricity,
                        ...
                        OutputVars.SpaceHeatingFuel(EnergyPlus::FuelTypeWood),
    ...
    dhw_output_vars = [OutputVars.WaterHeatingElectricity,
                       ...
                       OutputVars.WaterHeatingFuel(EnergyPlus::FuelTypeWood),
  ...
  def setup_outputs
    ...
    @end_uses[[FT::WoodCord, EUT::Heating]] = EndUse.new(variable: OutputVars.SpaceHeatingFuel(EnergyPlus::FuelTypeWood))
    @end_uses[[FT::WoodCord, EUT::HotWater]] = EndUse.new(variable: OutputVars.WaterHeatingFuel(EnergyPlus::FuelTypeWood))
