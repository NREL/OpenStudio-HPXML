...
class SimulationOutputReportTest < MiniTest::Test
  AnnualRows = [
    ...
    'Electricity: Mech Vent Preconditioning (MBtu)',
    ...
    'Natural Gas: Mech Vent Preconditioning (MBtu)',
    ...
    'Fuel Oil: Mech Vent Preconditioning (MBtu)',
    ...
    'Propane: Mech Vent Preconditioning (MBtu)',
    ...
    'Wood Cord: Mech Vent Preconditioning (MBtu)',
    ...
    'Wood Pellets: Mech Vent Preconditioning (MBtu)',
    'Coal: Heating (MBtu)',
    'Coal: Hot Water (MBtu)',
    ...
    'Coal: Lighting (MBtu)',
    'Coal: Fireplace (MBtu)',
    'Coal: Mech Vent Preconditioning (MBtu)',
    'Load: Heating (MBtu)',
    'Load: Cooling (MBtu)',
  ...
  TimeseriesColsEndUses = [
    ...
    'Electricity: Mech Vent Preconditioning',
    ...
    'Natural Gas: Mech Vent Preconditioning',
    'Fuel Oil: Heating',
    'Fuel Oil: Hot Water',
    ...
    'Fuel Oil: Lighting',
    'Fuel Oil: Fireplace',
    'Fuel Oil: Mech Vent Preconditioning',
    'Propane: Heating',
    'Propane: Hot Water',
    ...
    'Propane: Lighting',
    'Propane: Fireplace',
    'Propane: Mech Vent Preconditioning',
    'Wood Cord: Heating',
    'Wood Cord: Hot Water',
    ...
    'Wood Cord: Lighting',
    'Wood Cord: Fireplace',
    'Wood Cord: Mech Vent Preconditioning',
    ...
    'Wood Pellets: Mech Vent Preconditioning',
    'Coal: Heating',
    'Coal: Hot Water',
    'Coal: Clothes Dryer',
    'Coal: Range/Oven',
    ...
    'Coal: Lighting',
    'Coal: Fireplace',
    'Coal: Mech Vent Preconditioning',
  ]
  ...
  ERIRows = [
    ...
    'enduseElectricityMechVentPreconditioning',
