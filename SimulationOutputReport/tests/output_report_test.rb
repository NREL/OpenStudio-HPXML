...
class SimulationOutputReportTest < MiniTest::Test
  ...
  def test_timeseries_hourly_ALL_AMY_2012
    args_hash = { 'hpxml_path' => '../workflow/sample_files/base-location-epw-filename-AMY-2012.xml',
                  'timeseries_frequency' => 'hourly',
                  'include_timeseries_zone_temperatures' => true,
                  'include_timeseries_fuel_consumptions' => true,
                  'include_timeseries_end_use_consumptions' => true,
  ...
  def test_timeseries_hourly_ALL_AMY_2014
    args_hash = { 'hpxml_path' => '../workflow/sample_files/base-location-epw-filename-AMY-2014.xml',
                  'timeseries_frequency' => 'hourly',
                  'include_timeseries_zone_temperatures' => true,
                  'include_timeseries_fuel_consumptions' => true,
                  'include_timeseries_end_use_consumptions' => true,
  ...
  def test_timeseries_daily_ALL_AMY_2014
    args_hash = { 'hpxml_path' => '../workflow/sample_files/base-location-epw-filename-AMY-2014.xml',
                  'timeseries_frequency' => 'daily',
                  'include_timeseries_zone_temperatures' => true,
                  'include_timeseries_fuel_consumptions' => true,
  ...
  def test_timeseries_timestep_ALL_60min_AMY_2014
    args_hash = { 'hpxml_path' => '../workflow/sample_files/base-location-epw-filename-AMY-2014.xml',
                  'timeseries_frequency' => 'timestep',
                  'include_timeseries_zone_temperatures' => true,
                  'include_timeseries_fuel_consumptions' => true,
