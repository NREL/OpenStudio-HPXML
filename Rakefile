...
def create_hpxmls
  ...
  hpxmls_files = {
    ...
    'base-hvac-evap-cooler-furnace-gas.xml' => 'base-location-dallas-tx.xml',
    'base-hvac-evap-cooler-only.xml' => 'base-location-dallas-tx.xml',
    'base-hvac-evap-cooler-only-ducted.xml' => 'base-location-dallas-tx.xml',
