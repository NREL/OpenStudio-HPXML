...
class BO
  ...
  EnclosureWallAreaExteriorThermalBoundary = 'Enclosure: Wall Area Exterior Thermal Boundary'
  ...
  EnclosureWindowAreaFront = 'Enclosure: Window Area Front'
  EnclosureWindowAreaBack = 'Enclosure: Window Area Back'
  EnclosureWindowAreaLeft = 'Enclosure: Window Area Left'
  EnclosureWindowAreaRight = 'Enclosure: Window Area Right'
  EnclosureDoorArea = 'Enclosure: Door Area'
  EnclosureDuctArea = 'Enclosure: Duct Area'
  ...
  EnclosureSlabPerimeterInsulatedArea = 'Enclosure: Slab Perimeter Insulated Area'
  EnclosureSlabUnderSlabInsulatedArea = 'Enclosure: Slab Under-Slab Insulated Area'
  EnclosurePartitionWallArea = 'Enclosure: Partition Wall Area'
  ...
  SystemsPVCapacity = 'Systems: PV Capacity'

  AppliancesDehumidifierCapacity = 'Appliances: Dehumidifier Capacity'
  ...
  def self.get_units(bldg_type)
    if bldg_type.include? 'Area'
      ...
      return 'ft'
    elsif bldg_type.include? 'Dehumidifier Capacity'
      return 'pints/day'
    elsif bldg_type.include? 'PV Capacity'
      return 'W'
