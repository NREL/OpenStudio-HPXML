...
class HPXMLTest < MiniTest::Test
  ...
  def test_invalid
    ...
    expected_error_msgs = { 'boiler-invalid-afue.xml' => ['Expected AnnualHeatingEfficiency[Units="AFUE"]/Value to be less than or equal to 1'],
                            ...
                            'extra-occupancy-inputs.xml' => ['Expected 0 or 1 element(s) for xpath: extension/WeekdayScheduleFractions | /HPXML/SoftwareInfo/extension/SchedulesFilePath [context: /HPXML/Building/BuildingDetails/BuildingSummary/BuildingOccupancy]',
  ...
  def _verify_outputs(rundir, hpxml_path, results, hpxml)
    ...
    File.readlines(File.join(rundir, 'eplusout.err')).each do |err_line|
      ...
      if hpxml_path.include?('base-occupancy-detailed')
