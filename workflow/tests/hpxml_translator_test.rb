...
class HPXMLTest < MiniTest::Test
  ...
  def test_invalid
    ...
    expected_error_msgs = { 'appliances-location-unconditioned-space.xml' => ['Expected 1 element(s) for xpath: /HPXML/Building/BuildingDetails/Appliances/ClothesWasher: [not(Location)] |',
                            ...
                            'invalid-input-parameters.xml' => ["Expected value to be: //XMLTransactionHeaderInformation/Transaction: 'create' or 'update'",
                                                               "Expected value to be: //Building/BuildingDetails/BuildingSummary/Site/SiteType: 'rural' or 'suburban' or 'urban'",
                                                               "Expected value to be: //Building/BuildingDetails/ClimateandRiskZones/ClimateZoneIECC/Year: '2012' or '2009' or '2006' or '2003'",
                                                               'Expected value to be: //Building/BuildingDetails/Enclosure/Roofs/Roof/Azimuth: less than 360',
                                                               'Expected value to be: //Building/BuildingDetails/Enclosure/Roofs/Roof/RadiantBarrierGrade: less than or equal to 3',
                                                               'Expected value to be: //Building/BuildingDetails/Appliances/Dishwasher/EnergyFactor: less than or equal to 5',
                                                               'Expected 1 element(s) for xpath: /HPXML/Building/BuildingDetails/BuildingSummary/Site: [not(SiteType)] | SiteType[text()="urban" or text()="suburban" or text()="rural"]'],
