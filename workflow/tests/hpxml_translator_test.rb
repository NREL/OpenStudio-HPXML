...
class HPXMLTest < MiniTest::Test
  ...
  def test_invalid
    ...
    expected_error_msgs = { 'boiler-invalid-afue.xml' => ['Expected AnnualHeatingEfficiency[Units="AFUE"]/Value to be less than or equal to 1'],
                            ...
                            'invalid-skylights-properties.xml' => ["Could not lookup UFactor and SHGC for skylight 'SkylightSouth'."],
                            ...
                            'invalid-windows-properties.xml' => ["Could not lookup UFactor and SHGC for window 'WindowSouth'."],
