...
class HPXMLTest < MiniTest::Test
  ...
  def test_invalid
    ...
    expected_error_msgs = { 'boiler-invalid-afue.xml' => ['Expected AnnualHeatingEfficiency[Units="AFUE"]/Value to be less than or equal to 1'],
                            ...
                            'lighting-fractions.xml' => ['Expected sum of LightingGroup[Location="interior"]/FractionofUnitsInLocation to be less than one. [context: /HPXML/Building/BuildingDetails/Lighting]'],
