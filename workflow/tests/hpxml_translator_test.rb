...
class HPXMLTest < MiniTest::Test
  ...
  def test_invalid
    ...
    expected_error_msgs = { 'appliances-location-unconditioned-space.xml' => ['Expected [1] element(s) but found 0 element(s) for xpath: /HPXML/Building/BuildingDetails/Appliances/ClothesWasher: [not(Location)] |',
                            ...
                            'unattached-hot-water-distribution-water-heater.xml' => ["HotWaterDistributionSystem 'foobar' not found for water heating system"],
                            'unattached-hot-water-distribution-water-fixture.xml' => ["Attached hot water distribution 'foobar' not found for water fixture"],
                            'unattached-hot-water-distribution-clothes-washer.xml' => ["Attached hot water distribution 'foobar' not found for clothes washer"],
                            'unattached-hot-water-distribution-dishwasher.xml' => ["Attached hot water distribution 'foobar' not found for dishwasher"],
