...
def _run_xml(xml, worker_num, apply_unit_multiplier = false, results_1x = nil, timeseries_results_1x = nil)
  ...
  if unit_multiplier > 1
    _check_unit_multiplier_results(xml, hpxml.buildings[0], results_1x, results, timeseries_results_1x, timeseries_results, unit_multiplier)
  end
...
def _check_unit_multiplier_results(xml, hpxml_bldg, annual_results_1x, annual_results_10x, timeseries_results_1x, timeseries_results_10x, unit_multiplier)
