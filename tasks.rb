...
def create_hpxmls
  ...
  hpxmls_files = {
    ...
    'base-hvac-air-to-air-heat-pump-var-speed-max-capacity-schedule.xml' => 'base-hvac-air-to-air-heat-pump-var-speed.xml',
    ...
    'base-hvac-central-ac-only-var-speed-max-capacity-schedule.xml' => 'base-hvac-central-ac-only-var-speed.xml',
