...
def get_values(osw_file, step)
  ...
  if ['base.osw'].include? osw_file
    ...
    step.setArgument('hvac_control_heating_weekday_setpoint_schedule', '68')
    step.setArgument('hvac_control_heating_weekend_setpoint_schedule', '68')
    step.setArgument('hvac_control_cooling_weekday_setpoint_schedule', '78')
    step.setArgument('hvac_control_cooling_weekend_setpoint_schedule', '78')
  ...
  if ['base-hvac-air-to-air-heat-pump-1-speed.osw'].include? osw_file
    ...
    step.setArgument('hvac_control_heating_weekday_setpoint_schedule', '64, 64, 64, 64, 64, 64, 64, 70, 70, 66, 66, 66, 66, 66, 66, 66, 66, 68, 68, 68, 68, 68, 64, 64')
    step.setArgument('hvac_control_heating_weekend_setpoint_schedule', '68, 68, 68, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70')
    step.setArgument('hvac_control_cooling_weekday_setpoint_schedule', '80, 80, 80, 80, 80, 80, 80, 75, 75, 80, 80, 80, 80, 80, 80, 80, 80, 78, 78, 78, 78, 78, 80, 80')
    step.setArgument('hvac_control_cooling_weekend_setpoint_schedule', '78, 78, 78, 78, 78, 78, 78, 78, 78, 78, 78, 78, 78, 78, 78, 78, 78, 78, 78, 78, 78, 78, 78, 78')
    ...
    step.setArgument('hvac_control_heating_weekday_setpoint_schedule', '60')
    step.setArgument('hvac_control_heating_weekend_setpoint_schedule', '60')
    step.setArgument('hvac_control_cooling_weekday_setpoint_schedule', '80')
    step.setArgument('hvac_control_cooling_weekend_setpoint_schedule', '80')
