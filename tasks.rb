...
def apply_hpxml_modification(hpxml_file, hpxml)
  ...
  hpxml.buildings.each do |hpxml_bldg|
    ...
    if ['base-dhw-recirc-demand.xml'].include? hpxml_file
      ...
      hpxml_bldg.hot_water_distributions[0].recirculation_pump_weekday_fractions = Schedule.RecirculationPumpTemperatureControlledWeekdayFractions
      hpxml_bldg.hot_water_distributions[0].recirculation_pump_weekend_fractions = Schedule.RecirculationPumpTemperatureControlledWeekendFractions
      hpxml_bldg.hot_water_distributions[0].recirculation_pump_monthly_multipliers = Schedule.RecirculationPumpMonthlyMultipliers
    end
    ...
    if ['base-lighting-ceiling-fans.xml'].include? hpxml_file
      ...
      hpxml_bldg.lighting.interior_monthly_multipliers = Schedule.LightingMonthlyMultipliers
      ...
      hpxml_bldg.lighting.exterior_monthly_multipliers = Schedule.LightingMonthlyMultipliers
      ...
      hpxml_bldg.lighting.garage_monthly_multipliers = Schedule.LightingMonthlyMultipliers
