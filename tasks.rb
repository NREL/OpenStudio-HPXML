...
def set_hpxml_walls(hpxml_file, hpxml)
  if ['base.xml'].include? hpxml_file
    ...
    hpxml.walls[0].add_coordinate(x: 150, y: 0, z: 0)
    hpxml.walls[0].add_coordinate(x: 150, y: 0, z: 8)
    hpxml.walls[0].add_coordinate(x: 0, y: 0, z: 8)
    hpxml.walls[1].add_coordinate(x: 0, y: 0, z: 8)
    hpxml.walls[1].add_coordinate(x: 72.5, y: 0, z: 8)
    hpxml.walls[1].add_coordinate(x: 72.5, y: 0, z: 12)
    hpxml.walls[1].add_coordinate(x: 0, y: 0, z: 12)
  elsif ['base-atticroof-flat.xml'].include? hpxml_file
