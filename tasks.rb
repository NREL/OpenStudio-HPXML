...
def get_values(osw_file, step)
  ...
  if ['base.osw'].include? osw_file
    ...
    step.setArgument("heat_pump_fuel", "electricity")
    ...
    step.setArgument("refrigerator_location", "basement - conditioned")
    ...
    step.setArgument("heating_system_type", "none")
    step.setArgument("cooling_system_type", "none")
    step.setArgument("heat_pump_type", "air-to-air")
    step.setArgument("heat_pump_heating_capacity", 42000.0)
    step.setArgument("heat_pump_backup_fuel", "electricity")
