...
def get_values(osw_file, step)
  ...
  if ['base.osw'].include? osw_file
    ...
    step.setArgument('plug_loads_other_weekday_fractions', '0.04, 0.037, 0.037, 0.036, 0.033, 0.036, 0.043, 0.047, 0.034, 0.023, 0.024, 0.025, 0.024, 0.028, 0.031, 0.032, 0.039, 0.053, 0.063, 0.067, 0.071, 0.069, 0.059, 0.05')
    step.setArgument('plug_loads_other_weekend_fractions', '0.04, 0.037, 0.037, 0.036, 0.033, 0.036, 0.043, 0.047, 0.034, 0.023, 0.024, 0.025, 0.024, 0.028, 0.031, 0.032, 0.039, 0.053, 0.063, 0.067, 0.071, 0.069, 0.059, 0.05')
    ...
    step.setArgument('pool_heater_type', HPXML::HeaterTypeElectric)
    ...
    step.setArgument('hot_tub_heater_type', HPXML::HeaterTypeElectric)
    ...
    step.setArgument('plug_loads_well_pump_weekday_fractions', '0.04, 0.037, 0.037, 0.036, 0.033, 0.036, 0.043, 0.047, 0.034, 0.023, 0.024, 0.025, 0.024, 0.028, 0.031, 0.032, 0.039, 0.053, 0.063, 0.067, 0.071, 0.069, 0.059, 0.05')
    step.setArgument('plug_loads_well_pump_weekend_fractions', '0.04, 0.037, 0.037, 0.036, 0.033, 0.036, 0.043, 0.047, 0.034, 0.023, 0.024, 0.025, 0.024, 0.028, 0.031, 0.032, 0.039, 0.053, 0.063, 0.067, 0.071, 0.069, 0.059, 0.05')
    step.setArgument('plug_loads_well_pump_monthly_multipliers', '1.248, 1.257, 0.993, 0.989, 0.993, 0.827, 0.821, 0.821, 0.827, 0.99, 0.987, 1.248')
    step.setArgument('plug_loads_vehicle_present', true)
    step.setArgument('plug_loads_vehicle_annual_kwh', '1500.0')
    step.setArgument('plug_loads_vehicle_weekday_fractions', '0.04, 0.037, 0.037, 0.036, 0.033, 0.036, 0.043, 0.047, 0.034, 0.023, 0.024, 0.025, 0.024, 0.028, 0.031, 0.032, 0.039, 0.053, 0.063, 0.067, 0.071, 0.069, 0.059, 0.05')
    step.setArgument('plug_loads_vehicle_weekend_fractions', '0.04, 0.037, 0.037, 0.036, 0.033, 0.036, 0.043, 0.047, 0.034, 0.023, 0.024, 0.025, 0.024, 0.028, 0.031, 0.032, 0.039, 0.053, 0.063, 0.067, 0.071, 0.069, 0.059, 0.05')
    step.setArgument('plug_loads_vehicle_monthly_multipliers', '1.248, 1.257, 0.993, 0.989, 0.993, 0.827, 0.821, 0.821, 0.827, 0.99, 0.987, 1.248')
    ...
    step.setArgument('pool_heater_annual_kwh', '2100.0')
    ...
    step.setArgument('hot_tub_heater_annual_kwh', Constants.Auto)
    step.setArgument('hot_tub_heater_annual_therm', '500.0')
