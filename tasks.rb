...
def set_hpxml_water_heating_systems(hpxml_file, hpxml)
  if ['base.xml'].include? hpxml_file
    ...
    hpxml.water_heating_systems[0].setpoint_schedule_filepath = 'HPXMLtoOpenStudio/resources/schedule_files/heatpump/hourly_setpoint_schedule.csv'
    ...
    hpxml.water_heating_systems[0].operating_mode_schedule_filepath = 'HPXMLtoOpenStudio/resources/schedule_files/heatpump/hourly_operating_mode_schedule.csv'
  elsif ['base-dhw-tank-setpoint-type-scheduled.xml'].include? hpxml_file
    hpxml.water_heating_systems[0].setpoint_type = HPXML::WaterHeaterSetpointTypeScheduled
    hpxml.water_heating_systems[0].setpoint_schedule_filepath = 'HPXMLtoOpenStudio/resources/schedule_files/tank/hourly_setpoint_schedule.csv'
