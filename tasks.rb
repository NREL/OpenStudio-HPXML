...
def create_hpxmls
  ...
  hpxmls_files = {
    ...
    'base-enclosure-windows-natural-ventilation-setpoint.xml' => 'base.xml',
...
def set_measure_argument_values(hpxml_file, args, sch_args, orig_parent)
  ...
  elsif ['base-enclosure-windows-natural-ventilation-setpoint.xml'].include? hpxml_file
    args['natvent_setpoint'] = 72
