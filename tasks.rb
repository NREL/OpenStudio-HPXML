...
def create_hpxmls
  ...
  hpxmls_files = {
    ...
    'invalid_files/hvac-inconsistent-fan-watts-per-cfm.xml' => 'base.xml',
...
def set_hpxml_heating_systems(hpxml_file, hpxml)
  ...
  elsif ['invalid_files/hvac-inconsistent-fan-watts-per-cfm.xml'].include? hpxml_file
    hpxml.heating_systems[0].fan_watts_per_cfm = 0.4
...
def set_hpxml_cooling_systems(hpxml_file, hpxml)
  if ['base.xml'].include? hpxml_file
    ...
    hpxml.cooling_systems[0].fan_watts_per_cfm = 0.5
  elsif ['base-hvac-undersized.xml'].include? hpxml_file
