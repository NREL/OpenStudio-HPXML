...
def create_hpxmls
  ...
  hpxmls_files = {
    ...
    'base-schedules-detailed-stochastic-vacancy-year-round.xml' => 'base.xml',
...
def set_measure_argument_values(hpxml_file, args, sch_args, orig_parent)
  ...
  if ['base-schedules-detailed-stochastic.xml'].include? hpxml_file
    ...
    sch_args['hpxml_output_path'] = sch_args['hpxml_path']
  elsif ['base-schedules-detailed-stochastic-vacancy-year-round.xml'].include? hpxml_file
    sch_args['hpxml_path'] = args['hpxml_path']
    sch_args['schedules_type'] = 'stochastic'
    sch_args['schedules_vacancy_period'] = 'Jan 1 - Dec 31'
    sch_args['output_csv_path'] = '../../HPXMLtoOpenStudio/resources/schedule_files/stochastic-vacancy-year-round.csv'
    sch_args['hpxml_output_path'] = sch_args['hpxml_path']
