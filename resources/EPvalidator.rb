  ...
  def self.run_validator(hpxml_doc)
    ...
    requirements = {
      ...
      "/HPXML/Building/BuildingDetails/Systems/HVAC/HVACDistribution/DistributionSystemType/AirDistribution/Ducts[DuctType='supply' or DuctType='return']" => {
        ...
        "[DuctLocation='basement - unconditioned' or DuctLocation='crawlspace - vented' or DuctLocation='crawlspace - unvented' or DuctLocation='attic - vented' or DuctLocation='attic - unvented' or DuctLocation='attic - conditioned' or DuctLocation='garage']" => one,
        "DuctSurfaceArea" => one,
      },
