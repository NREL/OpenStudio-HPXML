...
class HPXML
  ...
  def self.get_ventilation_fan_values(ventilation_fan:,
    ...
    vals[:used_for_whole_building_ventilation] = to_bool_or_nil(XMLHelper.get_value(ventilation_fan, "UsedForWholeBuildingVentilation")) if is_selected(select, :used_for_whole_building_ventilation)
    vals[:used_for_seasonal_cooling_load_reduction] = to_bool_or_nil(XMLHelper.get_value(ventilation_fan, "UsedForSeasonalCoolingLoadReduction")) if is_selected(select, :used_for_seasonal_cooling_load_reduction)
