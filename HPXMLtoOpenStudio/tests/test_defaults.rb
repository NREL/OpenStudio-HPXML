...
class HPXMLtoOpenStudioDefaultsTest < Minitest::Test
  ...
  def test_central_air_conditioners
    ...
    hpxml_bldg.cooling_systems[0].fan_model_type = HPXML::HVACFanModelTypeBPM
    ...
    hpxml_bldg.cooling_systems[0].cooling_efficiency_eer = 11.0
    hpxml_bldg.cooling_systems[0].crankcase_heater_watts = 40.0
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_central_air_conditioner_values(default_hpxml_bldg.cooling_systems[0], 0.88, HPXML::HVACCompressorTypeVariableSpeed, 0.66, HPXML::HVACFanModelTypeBPM, nil, -0.11, -0.22, 12345, 12.0, 11.0, 40.0, 1.0)

    # Test defaults - SEER2/EER2
    ...
    hpxml_bldg.cooling_systems[0].cooling_efficiency_eer2 = 10.45
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_central_air_conditioner_values(default_hpxml_bldg.cooling_systems[0], 0.88, HPXML::HVACCompressorTypeVariableSpeed, 0.66, HPXML::HVACFanModelTypeBPM, nil, -0.11, -0.22, 12345, 12.0, 11.0, 40.0, 1.0)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_central_air_conditioner_values(default_hpxml_bldg.cooling_systems[0], 0.88, HPXML::HVACCompressorTypeVariableSpeed, 0.66, HPXML::HVACFanModelTypeBPM, nil, -0.11, -0.22, nil, 12.0, 11.0, 40.0, 1.2)

    # Test watts/cfm based on fan model type
    hpxml_bldg.cooling_systems[0].fan_watts_per_cfm = nil
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_central_air_conditioner_values(default_hpxml_bldg.cooling_systems[0], 0.88, HPXML::HVACCompressorTypeVariableSpeed, 0.375, HPXML::HVACFanModelTypeBPM, nil, -0.11, -0.22, nil, 12.0, 11.0, 40.0, 1.2)
    ...
    hpxml_bldg.cooling_systems[0].fan_model_type = nil
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_central_air_conditioner_values(default_hpxml_bldg.cooling_systems[0], 0.88, HPXML::HVACCompressorTypeSingleStage, 0.4, HPXML::HVACFanModelTypePSC, nil, -0.11, -0.22, nil, 12.0, 11.0, 40.0, 1.2)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_central_air_conditioner_values(default_hpxml_bldg.cooling_systems[0], 0.73, HPXML::HVACCompressorTypeSingleStage, 0.5, HPXML::HVACFanModelTypePSC, nil, 0, 0, nil, 12.0, 11.95, 50.0, 1.0)
  end
  ...
  def test_mini_split_air_conditioners
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_mini_split_air_conditioner_values(default_hpxml_bldg.cooling_systems[0], 0.78, 0.66, HPXML::HVACFanModelTypeBPM, nil, -0.11, -0.22, 12345, 19.0, 11.0, 40.0, HPXML::HVACCompressorTypeVariableSpeed, 1.0)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_mini_split_air_conditioner_values(default_hpxml_bldg.cooling_systems[0], 0.78, 0.66, HPXML::HVACFanModelTypeBPM, nil, -0.11, -0.22, nil, 19.0, 11.0, 40.0, HPXML::HVACCompressorTypeVariableSpeed, 1.2)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_mini_split_air_conditioner_values(default_hpxml_bldg.cooling_systems[0], 0.73, 0.18, HPXML::HVACFanModelTypeBPM, nil, 0, 0, nil, 19.0, 12.66, 50.0, HPXML::HVACCompressorTypeVariableSpeed, 1.0)

    # Test defaults w/ ductless
    hpxml_bldg.cooling_systems[0].distribution_system.delete
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_mini_split_air_conditioner_values(default_hpxml_bldg.cooling_systems[0], 0.73, 0.07, HPXML::HVACFanModelTypeBPM, nil, 0, 0, nil, 19.0, 10.68, 50.0, HPXML::HVACCompressorTypeVariableSpeed, 1.0)

    # Test defaults w/ ductless - SEER2/EER2
    hpxml_bldg.cooling_systems[0].cooling_efficiency_seer = nil
    hpxml_bldg.cooling_systems[0].cooling_efficiency_seer2 = 13.3
    hpxml_bldg.cooling_systems[0].cooling_efficiency_eer = nil
    hpxml_bldg.cooling_systems[0].cooling_efficiency_eer2 = 12.0
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_mini_split_air_conditioner_values(default_hpxml_bldg.cooling_systems[0], 0.73, 0.07, HPXML::HVACFanModelTypeBPM, nil, 0, 0, nil, 13.3, 12.0, 50.0, HPXML::HVACCompressorTypeVariableSpeed, 1.0)
  end
  ...
  def test_furnaces
    ...
    hpxml_bldg.heating_systems[0].fan_model_type = HPXML::HVACFanModelTypeBPM
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_furnace_values(default_hpxml_bldg.heating_systems[0], 0.66, HPXML::HVACFanModelTypeBPM, nil, -0.22, 12345, true, 999, 1.0)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_furnace_values(default_hpxml_bldg.heating_systems[0], 0.66, HPXML::HVACFanModelTypeBPM, nil, -0.22, nil, true, 999, 1.2)

    # Test watts/cfm based on fan model type
    hpxml_bldg.heating_systems[0].fan_watts_per_cfm = nil
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_furnace_values(default_hpxml_bldg.heating_systems[0], 0.375, HPXML::HVACFanModelTypeBPM, nil, -0.22, nil, true, 999, 1.2)

    # Test fan model type based on watts/cfm
    hpxml_bldg.heating_systems[0].fan_watts_per_cfm = 0.4
    hpxml_bldg.heating_systems[0].fan_model_type = nil
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_furnace_values(default_hpxml_bldg.heating_systems[0], 0.4, HPXML::HVACFanModelTypePSC, nil, -0.22, nil, true, 999, 1.2)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_furnace_values(default_hpxml_bldg.heating_systems[0], 0.5, HPXML::HVACFanModelTypePSC, nil, 0, nil, true, 500, 1.0)

    # Test defaults w/o pilot
    hpxml_bldg.heating_systems[0].pilot_light = nil
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_furnace_values(default_hpxml_bldg.heating_systems[0], 0.5, HPXML::HVACFanModelTypePSC, nil, 0, nil, false, nil, 1.0)
  ...
  def test_air_source_heat_pumps
    ...
    hpxml_bldg.heat_pumps[0].fan_model_type = HPXML::HVACFanModelTypeBPM
    ...
    hpxml_bldg.heat_pumps[0].cooling_efficiency_eer = 13.0
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_air_to_air_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.88, HPXML::HVACCompressorTypeVariableSpeed, 0.66, HPXML::HVACFanModelTypeBPM, nil, nil, -0.11, -0.22, 12345, 23456, nil, 34567, 14.0, 13.0, 8.0, 0.1, 2.0, 40.0, 1.0, 1.0, 1.0)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_air_to_air_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.88, HPXML::HVACCompressorTypeVariableSpeed, 0.66, HPXML::HVACFanModelTypeBPM, nil, nil, -0.11, -0.22, 12345, 23456, 9876, 34567, 14.0, 13.0, 8.0, nil, nil, 40.0, 1.0, 1.0, 1.0)

    # Test defaults - SEER2/HSPF2/EER2
    ...
    hpxml_bldg.heat_pumps[0].cooling_efficiency_eer2 = 12.35
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_air_to_air_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.88, HPXML::HVACCompressorTypeVariableSpeed, 0.66, HPXML::HVACFanModelTypeBPM, nil, nil, -0.11, -0.22, nil, nil, nil, nil, 14.0, 13.0, 8.0, 0.528, 5.0, 40.0, 1.5, 1.2, 1.1)

    # Test watts/cfm based on fan model type
    hpxml_bldg.heat_pumps[0].fan_watts_per_cfm = nil
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_air_to_air_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.88, HPXML::HVACCompressorTypeVariableSpeed, 0.375, HPXML::HVACFanModelTypeBPM, nil, nil, -0.11, -0.22, nil, nil, nil, nil, 14.0, 13.0, 8.0, 0.528, 5.0, 40.0, 1.5, 1.2, 1.1)

    # Test fan model type based on watts/cfm
    hpxml_bldg.heat_pumps[0].fan_watts_per_cfm = 0.17
    hpxml_bldg.heat_pumps[0].fan_model_type = nil
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_air_to_air_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.88, HPXML::HVACCompressorTypeVariableSpeed, 0.17, HPXML::HVACFanModelTypeBPM, nil, nil, -0.11, -0.22, nil, nil, nil, nil, 14.0, 13.0, 8.0, 0.528, 5.0, 40.0, 1.5, 1.2, 1.1)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_air_to_air_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.73, HPXML::HVACCompressorTypeSingleStage, 0.5, HPXML::HVACFanModelTypePSC, nil, nil, 0, 0, nil, nil, nil, nil, 14.0, 13.0, 8.0, 0.425, 5.0, 50.0, 1.0, 1.0, 1.0)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_air_to_air_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.88, HPXML::HVACCompressorTypeVariableSpeed, 0.66, HPXML::HVACFanModelTypeBPM, nil, nil, -0.11, -0.22, nil, nil, nil, nil, 14.0, 13.0, 8.0, 0.1, 2.0, 40.0, 1.0, 1.0, 1.0)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_air_to_air_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.88, HPXML::HVACCompressorTypeVariableSpeed, 0.66, HPXML::HVACFanModelTypeBPM, nil, nil, -0.11, -0.22, nil, nil, nil, nil, 14.0, 13.0, 8.0, (max_cap_at_5f / max_cap_at_47f).round(5), 5.0, 40.0, 1.0, 1.0, 1.0)

    hpxml_bldg.heat_pumps[0].heating_capacity_17F = 9876
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_air_to_air_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.88, HPXML::HVACCompressorTypeVariableSpeed, 0.66, HPXML::HVACFanModelTypeBPM, nil, nil, -0.11, -0.22, nil, nil, 9876, nil, 14.0, 13.0, 8.0, nil, nil, 40.0, 1.0, 1.0, 1.0)
  ...
  def test_mini_split_heat_pumps
    ...
    hpxml_bldg.heat_pumps[0].crankcase_heater_watts = 40.0
    hpxml_bldg.heat_pumps[0].compressor_type = HPXML::HVACCompressorTypeVariableSpeed
    hpxml_bldg.heat_pumps[0].cooling_efficiency_eer = 11.0
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_mini_split_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.78, 0.66, HPXML::HVACFanModelTypeBPM, nil, nil, -0.11, -0.22, 12345, 23456, nil, 34567, 19.0, 11.0, 10.0, 0.1, 2.0, 40.0, HPXML::HVACCompressorTypeVariableSpeed, 1.0, 1.0, 1.0)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_mini_split_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.78, 0.66, HPXML::HVACFanModelTypeBPM, nil, nil, -0.11, -0.22, 12345, 23456, 9876, 34567, 19.0, 11.0, 10.0, nil, nil, 40.0, HPXML::HVACCompressorTypeVariableSpeed, 1.0, 1.0, 1.0)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_mini_split_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.78, 0.66, HPXML::HVACFanModelTypeBPM, nil, nil, -0.11, -0.22, nil, nil, nil, nil, 19.0, 11.0, 10.0, 0.62, 5.0, 40.0, HPXML::HVACCompressorTypeVariableSpeed, 1.5, 1.2, 1.1)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_mini_split_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.73, 0.18, HPXML::HVACFanModelTypeBPM, nil, nil, 0, 0, nil, nil, nil, nil, 19.0, 11.0, 10.0, 0.62, 5.0, 50.0, HPXML::HVACCompressorTypeVariableSpeed, 1.0, 1.0, 1.0)

    # Test defaults w/ ductless and no backup
    hpxml_bldg.heat_pumps[0].distribution_system.delete
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_mini_split_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.73, 0.07, HPXML::HVACFanModelTypeBPM, nil, nil, 0, 0, nil, nil, nil, nil, 19.0, 11.0, 10.0, 0.62, 5.0, 50.0, HPXML::HVACCompressorTypeVariableSpeed, 1.0, 1.0, 1.0)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_mini_split_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.73, 0.07, HPXML::HVACFanModelTypeBPM, nil, nil, 0, 0, nil, nil, nil, nil, 13.3, 12.3, 7.56, 0.51, 5.0, 50.0, HPXML::HVACCompressorTypeVariableSpeed, 1.0, 1.0, 1.0)
  end
  ...
  def test_ground_source_heat_pumps
    ...
    hpxml_bldg.heat_pumps[0].fan_watts_per_cfm = 0.66
    hpxml_bldg.heat_pumps[0].fan_model_type = HPXML::HVACFanModelTypePSC
    hpxml_bldg.heat_pumps[0].airflow_defect_ratio = -0.22
    hpxml_bldg.heat_pumps[0].cooling_capacity = 12345
    hpxml_bldg.heat_pumps[0].heating_capacity = 23456
    hpxml_bldg.heat_pumps[0].backup_heating_capacity = 34567
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_ground_to_air_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 9.9, 0.66, HPXML::HVACFanModelTypePSC, nil, nil, -0.22, 12345, 23456, 34567)

    # Test watts/cfm based on fan model type
    hpxml_bldg.heat_pumps[0].fan_watts_per_cfm = nil
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_ground_to_air_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 9.9, 0.5, HPXML::HVACFanModelTypePSC, nil, nil, -0.22, 12345, 23456, 34567)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_ground_to_air_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 9.9, 0.17, HPXML::HVACFanModelTypeBPM, nil, nil, -0.22, 12345, 23456, 34567)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_ground_to_air_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 80.0, 0.375, HPXML::HVACFanModelTypeBPM, nil, nil, 0, nil, nil, nil)
  end
  ...
  def _test_default_central_air_conditioner_values(cooling_system, shr, compressor_type, fan_watts_per_cfm, fan_model_type, cooling_airflow_cfm, charge_defect_ratio,
                                                   airflow_defect_ratio, cooling_capacity, cooling_efficiency_seer, cooling_efficiency_eer, crankcase_heater_watts, cooling_autosizing_factor)
    ...
    assert_equal(fan_model_type, cooling_system.fan_model_type)
    ...
    if cooling_efficiency_eer.nil?
      ...
      assert_equal(cooling_efficiency_eer, cooling_system.cooling_efficiency_eer)
    end
  end
  ...
  def _test_default_mini_split_air_conditioner_values(cooling_system, shr, fan_watts_per_cfm, fan_model_type, cooling_airflow_cfm, charge_defect_ratio, airflow_defect_ratio,
                                                      cooling_capacity, cooling_efficiency_seer, cooling_efficiency_eer, crankcase_heater_watts, compressor_type, cooling_autosizing_factor)
    assert_equal(shr, cooling_system.cooling_shr)
    assert_equal(fan_watts_per_cfm, cooling_system.fan_watts_per_cfm)
    assert_equal(fan_model_type, cooling_system.fan_model_type)
    if cooling_airflow_cfm.nil? # nil implies an autosized value
  ...
  def _test_default_furnace_values(heating_system, fan_watts_per_cfm, fan_model_type, heating_airflow_cfm, airflow_defect_ratio, heating_capacity,
                                   pilot_light, pilot_light_btuh, heating_autosizing_factor)
    assert_equal(fan_watts_per_cfm, heating_system.fan_watts_per_cfm)
    if fan_model_type.nil?
      assert_nil(heating_system.fan_model_type)
    else
      assert_equal(fan_model_type, heating_system.fan_model_type)
    end
  ...
  def _test_default_air_to_air_heat_pump_values(heat_pump, shr, compressor_type, fan_watts_per_cfm, fan_model_type,
    ...
    assert_equal(fan_model_type, heat_pump.fan_model_type)
    if cooling_airflow_cfm.nil? # nil implies an autosized value
    ...
    if cooling_efficiency_eer.nil?
      ...
      assert_equal(cooling_efficiency_eer, heat_pump.cooling_efficiency_eer)
    end
  ...
  def _test_default_mini_split_heat_pump_values(heat_pump, shr, fan_watts_per_cfm, fan_model_type, heating_airflow_cfm, cooling_airflow_cfm,
                                                charge_defect_ratio, airflow_defect_ratio, cooling_capacity, heating_capacity, heating_capacity_17F,
                                                backup_heating_capacity, cooling_efficiency_seer, cooling_efficiency_eer, heating_efficiency_hspf,
                                                heating_capacity_retention_fraction, heating_capacity_retention_temp,
  ...
  def _test_default_ground_to_air_heat_pump_values(heat_pump, pump_watts_per_ton, fan_watts_per_cfm, fan_model_type, heating_airflow_cfm, cooling_airflow_cfm,
