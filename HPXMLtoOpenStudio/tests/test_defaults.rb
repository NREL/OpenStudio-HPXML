...
class HPXMLtoOpenStudioDefaultsTest < Minitest::Test
  ...
  def test_central_air_conditioners
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_central_air_conditioner_values(default_hpxml_bldg.cooling_systems[0], 0.88, HPXML::HVACCompressorTypeVariableSpeed, 0.66, HPXML::HVACFanModelTypeBPM, nil, -0.11, -0.22, 12345, 12.0, 40.0, 1.0)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_central_air_conditioner_values(default_hpxml_bldg.cooling_systems[0], 0.88, HPXML::HVACCompressorTypeVariableSpeed, 0.66, HPXML::HVACFanModelTypeBPM, nil, -0.11, -0.22, nil, 12.0, 40.0, 1.2)

    # Test watts/cfm based on fan model type
    hpxml_bldg.cooling_systems[0].fan_watts_per_cfm = nil
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_central_air_conditioner_values(default_hpxml_bldg.cooling_systems[0], 0.88, HPXML::HVACCompressorTypeVariableSpeed, 0.281, HPXML::HVACFanModelTypeBPM, nil, -0.11, -0.22, nil, 12.0, 40.0, 1.2)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_central_air_conditioner_values(default_hpxml_bldg.cooling_systems[0], 0.88, HPXML::HVACCompressorTypeSingleStage, 0.4, HPXML::HVACFanModelTypePSC, nil, -0.11, -0.22, nil, 12.0, 40.0, 1.2)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_central_air_conditioner_values(default_hpxml_bldg.cooling_systems[0], 0.73, HPXML::HVACCompressorTypeSingleStage, 0.414, HPXML::HVACFanModelTypePSC, nil, 0, 0, nil, 12.0, 50.0, 1.0)
  end
  ...
  def test_mini_split_air_conditioners
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_mini_split_air_conditioner_values(default_hpxml_bldg.cooling_systems[0], 0.78, 0.66, HPXML::HVACFanModelTypeBPM, nil, -0.11, -0.22, 12345, 19.0, 40.0, HPXML::HVACCompressorTypeVariableSpeed, 1.0)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_mini_split_air_conditioner_values(default_hpxml_bldg.cooling_systems[0], 0.78, 0.66, HPXML::HVACFanModelTypeBPM, nil, -0.11, -0.22, nil, 19.0, 40.0, HPXML::HVACCompressorTypeVariableSpeed, 1.2)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_mini_split_air_conditioner_values(default_hpxml_bldg.cooling_systems[0], 0.73, 0.281, HPXML::HVACFanModelTypeBPM, nil, 0, 0, nil, 19.0, 50.0, HPXML::HVACCompressorTypeVariableSpeed, 1.0)

    # Test defaults w/ ductless
    hpxml_bldg.cooling_systems[0].distribution_system.delete
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_mini_split_air_conditioner_values(default_hpxml_bldg.cooling_systems[0], 0.73, 0.171, HPXML::HVACFanModelTypeBPM, nil, 0, 0, nil, 19.0, 50.0, HPXML::HVACCompressorTypeVariableSpeed, 1.0)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_mini_split_air_conditioner_values(default_hpxml_bldg.cooling_systems[0], 0.73, 0.171, HPXML::HVACFanModelTypeBPM, nil, 0, 0, nil, 13.3, 50.0, HPXML::HVACCompressorTypeVariableSpeed, 1.0)
  end
  ...
  def test_furnaces
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_furnace_values(default_hpxml_bldg.heating_systems[0], 0.281, HPXML::HVACFanModelTypeBPM, nil, -0.22, nil, true, 999, 1.2)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_furnace_values(default_hpxml_bldg.heating_systems[0], 0.281, HPXML::HVACFanModelTypeBPM, nil, 0, nil, true, 500, 1.0)

    # Test defaults w/o pilot
    hpxml_bldg.heating_systems[0].pilot_light = nil
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_furnace_values(default_hpxml_bldg.heating_systems[0], 0.281, HPXML::HVACFanModelTypeBPM, nil, 0, nil, false, nil, 1.0)
  ...
  def test_air_source_heat_pumps
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_air_to_air_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.88, HPXML::HVACCompressorTypeVariableSpeed, 0.66, HPXML::HVACFanModelTypeBPM, nil, nil, -0.11, -0.22, 12345, 23456, nil, 34567, 14.0, 8.0, 0.1, 2.0, 40.0, 1.0, 1.0, 1.0)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_air_to_air_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.88, HPXML::HVACCompressorTypeVariableSpeed, 0.66, HPXML::HVACFanModelTypeBPM, nil, nil, -0.11, -0.22, 12345, 23456, 9876, 34567, 14.0, 8.0, nil, nil, 40.0, 1.0, 1.0, 1.0)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_air_to_air_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.88, HPXML::HVACCompressorTypeVariableSpeed, 0.66, HPXML::HVACFanModelTypeBPM, nil, nil, -0.11, -0.22, nil, nil, nil, nil, 14.0, 8.0, 0.528, 5.0, 40.0, 1.5, 1.2, 1.1)

    # Test watts/cfm based on fan model type
    hpxml_bldg.heat_pumps[0].fan_watts_per_cfm = nil
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_air_to_air_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.88, HPXML::HVACCompressorTypeVariableSpeed, 0.281, HPXML::HVACFanModelTypeBPM, nil, nil, -0.11, -0.22, nil, nil, nil, nil, 14.0, 8.0, 0.528, 5.0, 40.0, 1.5, 1.2, 1.1)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_air_to_air_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.88, HPXML::HVACCompressorTypeVariableSpeed, 0.17, HPXML::HVACFanModelTypeBPM, nil, nil, -0.11, -0.22, nil, nil, nil, nil, 14.0, 8.0, 0.528, 5.0, 40.0, 1.5, 1.2, 1.1)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_air_to_air_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.73, HPXML::HVACCompressorTypeSingleStage, 0.414, HPXML::HVACFanModelTypePSC, nil, nil, 0, 0, nil, nil, nil, nil, 14.0, 8.0, 0.425, 5.0, 50.0, 1.0, 1.0, 1.0)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_air_to_air_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.88, HPXML::HVACCompressorTypeVariableSpeed, 0.66, HPXML::HVACFanModelTypeBPM, nil, nil, -0.11, -0.22, nil, nil, nil, nil, 14.0, 8.0, 0.1, 2.0, 40.0, 1.0, 1.0, 1.0)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_air_to_air_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.88, HPXML::HVACCompressorTypeVariableSpeed, 0.66, HPXML::HVACFanModelTypeBPM, nil, nil, -0.11, -0.22, nil, nil, nil, nil, 14.0, 8.0, (max_cap_at_5f / max_cap_at_47f).round(5), 5.0, 40.0, 1.0, 1.0, 1.0)

    hpxml_bldg.heat_pumps[0].heating_capacity_17F = 9876
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_air_to_air_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.88, HPXML::HVACCompressorTypeVariableSpeed, 0.66, HPXML::HVACFanModelTypeBPM, nil, nil, -0.11, -0.22, nil, nil, 9876, nil, 14.0, 8.0, nil, nil, 40.0, 1.0, 1.0, 1.0)
  ...
  def test_mini_split_heat_pumps
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_mini_split_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.78, 0.66, HPXML::HVACFanModelTypeBPM, nil, nil, -0.11, -0.22, 12345, 23456, nil, 34567, 19.0, 10.0, 0.1, 2.0, 40.0, HPXML::HVACCompressorTypeVariableSpeed, 1.0, 1.0, 1.0)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_mini_split_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.78, 0.66, HPXML::HVACFanModelTypeBPM, nil, nil, -0.11, -0.22, 12345, 23456, 9876, 34567, 19.0, 10.0, nil, nil, 40.0, HPXML::HVACCompressorTypeVariableSpeed, 1.0, 1.0, 1.0)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_mini_split_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.78, 0.66, HPXML::HVACFanModelTypeBPM, nil, nil, -0.11, -0.22, nil, nil, nil, nil, 19.0, 10.0, 0.62, 5.0, 40.0, HPXML::HVACCompressorTypeVariableSpeed, 1.5, 1.2, 1.1)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_mini_split_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.73, 0.281, HPXML::HVACFanModelTypeBPM, nil, nil, 0, 0, nil, nil, nil, nil, 19.0, 10.0, 0.62, 5.0, 50.0, HPXML::HVACCompressorTypeVariableSpeed, 1.0, 1.0, 1.0)

    # Test defaults w/ ductless and no backup
    hpxml_bldg.heat_pumps[0].distribution_system.delete
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_mini_split_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.73, 0.171, HPXML::HVACFanModelTypeBPM, nil, nil, 0, 0, nil, nil, nil, nil, 19.0, 10.0, 0.62, 5.0, 50.0, HPXML::HVACCompressorTypeVariableSpeed, 1.0, 1.0, 1.0)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_mini_split_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 0.73, 0.171, HPXML::HVACFanModelTypeBPM, nil, nil, 0, 0, nil, nil, nil, nil, 13.3, 7.56, 0.51, 5.0, 50.0, HPXML::HVACCompressorTypeVariableSpeed, 1.0, 1.0, 1.0)
  end
  ...
  def test_ground_source_heat_pumps
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_ground_to_air_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 9.9, 0.414, HPXML::HVACFanModelTypePSC, nil, nil, -0.22, 12345, 23456, 34567)
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_ground_to_air_heat_pump_values(default_hpxml_bldg.heat_pumps[0], 30.0, 0.281, HPXML::HVACFanModelTypeBPM, nil, nil, 0, nil, nil, nil)
  end
  ...
  def test_mech_ventilation_fans
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_mech_vent_values(default_hpxml_bldg, false, 8.0, 224.8, 305.4, 1.0, HPXML::CFISModeAirHandler, true, HPXML::CFISControlTypeOptimized)
  ...
  def _test_default_mini_split_heat_pump_values(heat_pump, shr, fan_watts_per_cfm, fan_model_type, heating_airflow_cfm, cooling_airflow_cfm,
                                                charge_defect_ratio, airflow_defect_ratio, cooling_capacity, heating_capacity,
                                                heating_capacity_17F, backup_heating_capacity,
                                                cooling_efficiency_seer, heating_efficiency_hspf,
                                                heating_capacity_retention_fraction, heating_capacity_retention_temp,
