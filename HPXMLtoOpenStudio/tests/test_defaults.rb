...
class HPXMLtoOpenStudioDefaultsTest < MiniTest::Test
  ...
  def test_header
    ...
    hpxml.header.seasons_summer_begin_month = 1
    hpxml.header.seasons_summer_begin_day = 2
    hpxml.header.seasons_summer_end_month = 3
    hpxml.header.seasons_summer_end_day = 4
    XMLHelper.write_file(hpxml.to_oga, @tmp_hpxml_path)
    hpxml_default = _test_measure()
    _test_default_header_values(hpxml_default, 30, 2, 2, 11, 11, 2009, false, 3, 3, 10, 10, HPXML::HeatPumpSizingMaxLoad,
                                true, 'CA', -8, HPXML::OccupancyCalculationTypeOperational, 1.5, 7, 1, 2, 3, 4)
    ...
    hpxml.header.seasons_summer_begin_month = nil
    hpxml.header.seasons_summer_begin_day = nil
    hpxml.header.seasons_summer_end_month = nil
    hpxml.header.seasons_summer_end_day = nil
    XMLHelper.write_file(hpxml.to_oga, @tmp_hpxml_path)
    hpxml_default = _test_measure()
    _test_default_header_values(hpxml_default, 60, 1, 1, 12, 31, 2007, true, 3, 12, 11, 5, HPXML::HeatPumpSizingHERS,
                                false, 'CO', -7, HPXML::OccupancyCalculationTypeAsset, 1.0, 3, 4, 15, 10, 14)
    ...
    # Test defaults - invalid state code, southern hemisphere
    ...
    _test_default_header_values(hpxml_default, 60, 1, 1, 12, 31, 2007, true, 3, 12, 11, 5, nil,
                                false, nil, 2, HPXML::OccupancyCalculationTypeAsset, 1.0, 3, 10, 15, 4, 14)
  end
  ...
  def _test_default_header_values(hpxml, tstep, sim_begin_month, sim_begin_day, sim_end_month, sim_end_day, sim_calendar_year,
                                  ...
                                  temperature_capacitance_multiplier, natvent_days_per_week, seasons_summer_begin_month,
                                  seasons_summer_begin_day, seasons_summer_end_month, seasons_summer_end_day)
    ...
    assert_equal(seasons_summer_begin_month, hpxml.header.seasons_summer_begin_month)
    assert_equal(seasons_summer_begin_day, hpxml.header.seasons_summer_begin_day)
    assert_equal(seasons_summer_end_month, hpxml.header.seasons_summer_end_month)
    assert_equal(seasons_summer_end_day, hpxml.header.seasons_summer_end_day)
  end
