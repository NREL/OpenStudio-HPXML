...
class HPXMLtoOpenStudioDefaultsTest < Minitest::Test
  ...
  def test_utility_bills
    ...
    default_hpxml.header.utility_bill_scenarios.each do |scenario|
      _test_default_bills_values(scenario, 12, 12, nil, nil, nil, nil, nil, 0.12423203139911637, 1.0467873090481787, nil, nil, nil, nil, nil, HPXML::PVCompensationTypeNetMetering, HPXML::PVAnnualExcessSellbackRateTypeUserSpecified, 0.03, nil, nil, 0)
    end
    ...
    default_hpxml, _default_hpxml_bldg = _test_measure()
    default_hpxml.header.utility_bill_scenarios.each do |scenario|
      _test_default_bills_values(scenario, nil, 12, nil, nil, nil, nil, nil, nil, 1.0467873090481787, nil, nil, nil, nil, nil, HPXML::PVCompensationTypeNetMetering, HPXML::PVAnnualExcessSellbackRateTypeUserSpecified, 0.03, nil, nil, 0)
    end
  end
