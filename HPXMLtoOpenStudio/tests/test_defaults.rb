...
class HPXMLtoOpenStudioDefaultsTest < Minitest::Test
  ...
  def test_utility_bills
    ...
    default_hpxml.header.utility_bill_scenarios.each do |scenario|
      _test_default_bills_values(scenario, 12, 12, nil, nil, nil, nil, nil, 0.1315, 0.9688, nil, nil, nil, nil, nil, HPXML::PVCompensationTypeNetMetering, HPXML::PVAnnualExcessSellbackRateTypeUserSpecified, 0.03, nil, nil, 0)
    end
