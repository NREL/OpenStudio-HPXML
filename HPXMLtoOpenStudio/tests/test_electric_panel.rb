...
class HPXMLtoOpenStudioElectricPanelTest < Minitest::Test
  ...
  def test_ashp_upgrade
    ...
    assert_equal(9, electric_panel.breaker_spaces_occupied)
    assert_equal(14 - 9, electric_panel.breaker_spaces_headroom)
    assert_in_epsilon(9444.2, electric_panel.capacity_total_watts[0], 0.01)
    assert_in_epsilon(9444.2 / Float(HPXML::ElectricPanelVoltage240), electric_panel.capacity_total_amps[0], 0.01)
    assert_in_epsilon(electric_panel.max_current_rating - 9444.2 / Float(HPXML::ElectricPanelVoltage240), electric_panel.capacity_headroom_amps[0], 0.01)
    assert_in_epsilon(5625.0, electric_panel.capacity_total_watts[1], 0.01)
  ...
  def test_hvac_configurations
    ...
    _test_occupied_spaces(hpxml_bldg, [HPXML::ElectricPanelLoadTypeHeating, HPXML::ElectricPanelLoadTypeCooling], 0)
    ...
    hpxml, hpxml_bldg = _create_hpxml('base-hvac-furnace-gas-only.xml', test_name)
    branch_circuits = hpxml_bldg.electric_panels[0].branch_circuits
    branch_circuits.add(id: "BranchCircuit#{branch_circuits.size + 1}",
    ...
    _test_occupied_spaces(hpxml_bldg, [HPXML::ElectricPanelLoadTypeHeating, HPXML::ElectricPanelLoadTypeCooling], 1)
    ...
    hpxml, hpxml_bldg = _create_hpxml('base-hvac-boiler-gas-only.xml', test_name)
    branch_circuits = hpxml_bldg.electric_panels[0].branch_circuits
    branch_circuits.add(id: "BranchCircuit#{branch_circuits.size + 1}",
                        component_idrefs: [hpxml_bldg.hvac_distributions[0].id])
    branch_circuits.add(id: "BranchCircuit#{branch_circuits.size + 1}",
    ...
    _test_service_feeder_power(hpxml_bldg, HPXML::ElectricPanelLoadTypeCooling, 400 + 4022)
    _test_occupied_spaces(hpxml_bldg, [HPXML::ElectricPanelLoadTypeHeating, HPXML::ElectricPanelLoadTypeCooling], 7)
    ...
    hpxml, hpxml_bldg = _create_hpxml('base-hvac-dual-fuel-air-to-air-heat-pump-1-speed.xml', test_name)
    branch_circuits = hpxml_bldg.electric_panels[0].branch_circuits
    branch_circuits.add(id: "BranchCircuit#{branch_circuits.size + 1}",
                        component_idrefs: [hpxml_bldg.hvac_distributions[0].id])
    branch_circuits.add(id: "BranchCircuit#{branch_circuits.size + 1}",
    ...
    hpxml, hpxml_bldg = _create_hpxml('base-hvac-air-to-air-heat-pump-var-speed-backup-boiler.xml', test_name)
    branch_circuits = hpxml_bldg.electric_panels[0].branch_circuits
    branch_circuits.add(id: "BranchCircuit#{branch_circuits.size + 1}",
                        component_idrefs: [hpxml_bldg.heating_systems[0].id,
                                           hpxml_bldg.hvac_distributions[0].id])
    ...
    hpxml, hpxml_bldg = _create_hpxml('base-hvac-air-to-air-heat-pump-var-speed-backup-boiler-switchover-temperature.xml', test_name)
    branch_circuits = hpxml_bldg.electric_panels[0].branch_circuits
    branch_circuits.add(id: "BranchCircuit#{branch_circuits.size + 1}",
                        component_idrefs: [hpxml_bldg.heating_systems[0].id,
                                           hpxml_bldg.hvac_distributions[0].id])
    ...
    hpxml, hpxml_bldg = _create_hpxml('base-hvac-air-to-air-heat-pump-1-speed-heating-only.xml', test_name)
    branch_circuits = hpxml_bldg.electric_panels[0].branch_circuits
    branch_circuits.add(id: "BranchCircuit#{branch_circuits.size + 1}",
                        component_idrefs: [hpxml_bldg.heat_pumps[0].id,
                                           hpxml_bldg.hvac_distributions[0].id])
    ...
    hpxml, hpxml_bldg = _create_hpxml('base-hvac-air-to-air-heat-pump-1-speed-cooling-only.xml', test_name)
    branch_circuits = hpxml_bldg.electric_panels[0].branch_circuits
    branch_circuits.add(id: "BranchCircuit#{branch_circuits.size + 1}",
                        component_idrefs: [hpxml_bldg.hvac_distributions[0].id])
    branch_circuits.add(id: "BranchCircuit#{branch_circuits.size + 1}",
    ...
    hpxml, hpxml_bldg = _create_hpxml('base-hvac-dual-fuel-mini-split-heat-pump-ducted.xml', test_name)
    branch_circuits = hpxml_bldg.electric_panels[0].branch_circuits
    branch_circuits.add(id: "BranchCircuit#{branch_circuits.size + 1}",
                        component_idrefs: [hpxml_bldg.hvac_distributions[0].id])
    branch_circuits.add(id: "BranchCircuit#{branch_circuits.size + 1}",
    ...
    hpxml, hpxml_bldg = _create_hpxml('base-hvac-mini-split-heat-pump-ductless.xml', test_name)
    branch_circuits = hpxml_bldg.electric_panels[0].branch_circuits
    branch_circuits.add(id: "BranchCircuit#{branch_circuits.size + 1}",
                        component_idrefs: [hpxml_bldg.heat_pumps[0].id])
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _model, _hpxml, hpxml_bldg = _test_measure(args_hash)
    _test_service_feeder_power(hpxml_bldg, HPXML::ElectricPanelLoadTypeHeating, 5839)
    _test_service_feeder_power(hpxml_bldg, HPXML::ElectricPanelLoadTypeCooling, 5839)
    _test_occupied_spaces(hpxml_bldg, [HPXML::ElectricPanelLoadTypeHeating, HPXML::ElectricPanelLoadTypeCooling], 2)

    test_name = 'Ductless MSHP w/separate electric backup'
    hpxml, hpxml_bldg = _create_hpxml('base-hvac-mini-split-heat-pump-ductless-backup-baseboard.xml', test_name)
    branch_circuits = hpxml_bldg.electric_panels[0].branch_circuits
    branch_circuits.add(id: "BranchCircuit#{branch_circuits.size + 1}",
                        component_idrefs: [hpxml_bldg.heating_systems[0].id])
    branch_circuits.add(id: "BranchCircuit#{branch_circuits.size + 1}",
    ...
    _test_service_feeder_power(hpxml_bldg, HPXML::ElectricPanelLoadTypeHeating, 3114 + 17584)
    _test_service_feeder_power(hpxml_bldg, HPXML::ElectricPanelLoadTypeCooling, 3114)
    _test_occupied_spaces(hpxml_bldg, [HPXML::ElectricPanelLoadTypeHeating, HPXML::ElectricPanelLoadTypeCooling], 6)

    test_name = 'Ductless MSHP w/separate gas backup'
    hpxml, hpxml_bldg = _create_hpxml('base-hvac-mini-split-heat-pump-ductless-backup-furnace.xml', test_name)
    branch_circuits = hpxml_bldg.electric_panels[0].branch_circuits
    branch_circuits.add(id: "BranchCircuit#{branch_circuits.size + 1}",
                        component_idrefs: [hpxml_bldg.heating_systems[0].id,
                                           hpxml_bldg.hvac_distributions[0].id])
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _model, _hpxml, hpxml_bldg = _test_measure(args_hash)
    _test_service_feeder_power(hpxml_bldg, HPXML::ElectricPanelLoadTypeHeating, 3114 + 655)
    _test_service_feeder_power(hpxml_bldg, HPXML::ElectricPanelLoadTypeCooling, 3114)
    _test_occupied_spaces(hpxml_bldg, [HPXML::ElectricPanelLoadTypeHeating, HPXML::ElectricPanelLoadTypeCooling], 3)
  end
  ...
  def test_water_heater_configurations
    ...
    hpxml, hpxml_bldg = _create_hpxml('base-dhw-tankless-electric.xml', test_name)
    branch_circuits = hpxml_bldg.electric_panels[0].branch_circuits
    branch_circuits.add(id: "BranchCircuit#{branch_circuits.size + 1}",
                        voltage: HPXML::ElectricPanelVoltage240,
                        component_idrefs: [hpxml_bldg.water_heating_systems[0].id])
    ...
    hpxml, hpxml_bldg = _create_hpxml('base-dhw-tank-heat-pump.xml', test_name)
    branch_circuits = hpxml_bldg.electric_panels[0].branch_circuits
    branch_circuits.add(id: "BranchCircuit#{branch_circuits.size + 1}",
                        voltage: HPXML::ElectricPanelVoltage240,
                        component_idrefs: [hpxml_bldg.water_heating_systems[0].id])
    ...
    hpxml, hpxml_bldg = _create_hpxml('base-dhw-tank-heat-pump-capacities.xml', test_name)
    branch_circuits = hpxml_bldg.electric_panels[0].branch_circuits
    branch_circuits.add(id: "BranchCircuit#{branch_circuits.size + 1}",
                        voltage: HPXML::ElectricPanelVoltage240,
                        component_idrefs: [hpxml_bldg.water_heating_systems[0].id])
  ...
  def test_ventilation_fans_configurations
    ...
    hpxml, hpxml_bldg = _create_hpxml('base-mechvent-bath-kitchen-fans.xml', test_name)
    branch_circuits = hpxml_bldg.electric_panels[0].branch_circuits
    branch_circuits.add(id: "BranchCircuit#{branch_circuits.size + 1}",
                        voltage: HPXML::ElectricPanelVoltage120,
                        component_idrefs: [hpxml_bldg.ventilation_fans[0].id,
                                           hpxml_bldg.ventilation_fans[1].id])
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _model, _hpxml, hpxml_bldg = _test_measure(args_hash)
    ...
    hpxml, hpxml_bldg = _create_hpxml('base-mechvent-exhaust.xml', test_name)
    branch_circuits = hpxml_bldg.electric_panels[0].branch_circuits
    branch_circuits.add(id: "BranchCircuit#{branch_circuits.size + 1}",
                        voltage: HPXML::ElectricPanelVoltage120,
                        component_idrefs: [hpxml_bldg.ventilation_fans[0].id])
  ...
  def _create_hpxml(hpxml_name, test_name = nil)
    ...
    hpxml.header.service_feeders_load_calculation_types = [HPXML::ElectricPanelLoadCalculationType2023ExistingDwellingLoadBased, HPXML::ElectricPanelLoadCalculationType2023ExistingDwellingMeterBased]
