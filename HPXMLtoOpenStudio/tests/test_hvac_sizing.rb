...
class HPXMLtoOpenStudioHVACSizingTest < Minitest::Test
  ...
  def test_manual_j_residences
    ...
    smaller_tol_btuh = 100 # Individual block load components
    ...
    assert_in_delta(3089, hpxml_bldg.hvac_plant.hdl_infil, smaller_tol_btuh)
    ...
    assert_in_delta(769, hpxml_bldg.hvac_plant.cdl_sens_infil, smaller_tol_btuh)
    ...
    assert_in_delta(1276, hpxml_bldg.hvac_plant.cdl_lat_infil, smaller_tol_btuh)
    ...
    # Fixme: I'm not quite sure how to use Table 5A/5B for looking up,
    # from some examples, eg. Bob Ross and Bell, it seems it expects us to assmue CFA = volume / 8ft (default height) to look up,
    # so that the actual ceiling height has some impact on the infiltration default values.
    # but this example directly uses 1800 sqft. And I don't know why it has 26100 cu.ft infiltration volume
    ...
    # Fixme: The same question as above
    ...
    assert_in_delta(6944, hpxml_bldg.hvac_plant.hdl_infil, smaller_tol_btuh)
    assert_in_delta(0, hpxml_bldg.hvac_plant.hdl_vent, block_tol_btuh)
    assert_in_delta(0, hpxml_bldg.hvac_plant.hdl_piping, block_tol_btuh)
    ...
    assert_in_delta(565, hpxml_bldg.hvac_plant.cdl_sens_infil, smaller_tol_btuh)
    assert_in_delta(0, hpxml_bldg.hvac_plant.cdl_sens_vent, block_tol_btuh)
    assert_in_delta(3320, hpxml_bldg.hvac_plant.cdl_sens_intgains, block_tol_btuh)
    assert_in_delta(1707, hpxml_bldg.hvac_plant.cdl_sens_blowerheat, block_tol_btuh)
    assert_in_delta(0, hpxml_bldg.hvac_plant.cdl_lat_ducts, block_tol_btuh)
    assert_in_delta(998, hpxml_bldg.hvac_plant.cdl_lat_infil, 155.0) # difference because cooling and heating have different conditioned areas
    assert_in_delta(0, hpxml_bldg.hvac_plant.cdl_lat_vent, block_tol_btuh)
    ...
    assert_in_delta(11237, hpxml_bldg.hvac_plant.hdl_infil, smaller_tol_btuh)
    ...
    assert_in_delta(1054, hpxml_bldg.hvac_plant.cdl_sens_infil, smaller_tol_btuh)
    ...
    assert_in_delta(1651, hpxml_bldg.hvac_plant.cdl_lat_infil, smaller_tol_btuh)
    ...
    assert_in_delta(456, hpxml_bldg.hvac_plant.hdl_infil, smaller_tol_btuh)
    ...
    assert_in_delta(0, hpxml_bldg.hvac_plant.cdl_sens_infil, smaller_tol_btuh)
    ...
    assert_in_delta(0, hpxml_bldg.hvac_plant.hdl_slabs, block_tol_btuh)
    assert_in_delta(0, hpxml_bldg.hvac_plant.hdl_ceilings, block_tol_btuh)
    assert_in_delta(1770, hpxml_bldg.hvac_plant.hdl_infil, smaller_tol_btuh)
    assert_in_delta(0, hpxml_bldg.hvac_plant.hdl_vent, block_tol_btuh)
    assert_in_delta(0, hpxml_bldg.hvac_plant.hdl_piping, block_tol_btuh)
    ...
    assert_in_delta(0, hpxml_bldg.hvac_plant.cdl_sens_slabs, block_tol_btuh)
    assert_in_delta(0, hpxml_bldg.hvac_plant.cdl_sens_ceilings, block_tol_btuh)
    assert_in_delta(764, hpxml_bldg.hvac_plant.cdl_sens_infil, smaller_tol_btuh)
    assert_in_delta(0, hpxml_bldg.hvac_plant.cdl_sens_vent, block_tol_btuh)
    ...
    assert_in_delta(1391, hpxml_bldg.hvac_plant.cdl_lat_infil, smaller_tol_btuh)
    assert_in_delta(0, hpxml_bldg.hvac_plant.cdl_lat_vent, block_tol_btuh)
    assert_in_delta(800, hpxml_bldg.hvac_plant.cdl_lat_intgains, block_tol_btuh)
    ...
    assert_in_delta(1760, hpxml_bldg.hvac_plant.hdl_infil, 260.0) # Difference caused by table look up, 1501 to 2000 tight values are used in the example, but cfa 1449 (1288 sqft * 9ft / 8) is used in the workflow (HPXML cfa is 1288 sqft)
    ...
    assert_in_delta(317, hpxml_bldg.hvac_plant.cdl_sens_infil, smaller_tol_btuh)
    ...
    assert_in_delta(241, hpxml_bldg.hvac_plant.cdl_lat_infil, smaller_tol_btuh)
