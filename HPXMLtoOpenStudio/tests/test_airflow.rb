...
class HPXMLtoOpenStudioAirflowTest < Minitest::Test
  ...
  def test_duct_effective_r_values
    ...
    # Supply, uninsulated
    effective_r = HPXMLDefaults.get_default_duct_effective_r_value(0.0, HPXML::DuctTypeSupply, HPXML::DuctBuriedInsulationNone, f_rect_supply)
    assert_equal(1.7, effective_r)

    # Return, uninsulated
    effective_r = HPXMLDefaults.get_default_duct_effective_r_value(0.0, HPXML::DuctTypeReturn, HPXML::DuctBuriedInsulationNone, f_rect_return)
    assert_equal(1.7, effective_r)
    ...
    { 4.2 => 4.53,
      ...
      effective_r = HPXMLDefaults.get_default_duct_effective_r_value(nominal_r, HPXML::DuctTypeSupply, HPXML::DuctBuriedInsulationNone, f_rect_supply)
    ...
    { 4.2 => 5.20,
      ...
      effective_r = HPXMLDefaults.get_default_duct_effective_r_value(nominal_r, HPXML::DuctTypeReturn, HPXML::DuctBuriedInsulationNone, f_rect_return)
      assert_in_epsilon(expected_r, effective_r, 0.1)
    end
    ...
    { 4.2 => 6.8,
      ...
      effective_r = HPXMLDefaults.get_default_duct_effective_r_value(nominal_r, HPXML::DuctTypeSupply, HPXML::DuctBuriedInsulationPartial, f_rect_supply)
      assert_in_epsilon(expected_r, effective_r, 0.1)
    end
    ...
    { 4.2 => 10.1,
      ...
      effective_r = HPXMLDefaults.get_default_duct_effective_r_value(nominal_r, HPXML::DuctTypeReturn, HPXML::DuctBuriedInsulationPartial, f_rect_return)
      assert_in_epsilon(expected_r, effective_r, 0.1)
    end
    ...
    { 4.2 => 9.9,
      ...
      effective_r = HPXMLDefaults.get_default_duct_effective_r_value(nominal_r, HPXML::DuctTypeSupply, HPXML::DuctBuriedInsulationFull, f_rect_supply)
      assert_in_epsilon(expected_r, effective_r, 0.1)
    end
    ...
    { 4.2 => 14.3,
      ...
      effective_r = HPXMLDefaults.get_default_duct_effective_r_value(nominal_r, HPXML::DuctTypeReturn, HPXML::DuctBuriedInsulationFull, f_rect_return)
      assert_in_epsilon(expected_r, effective_r, 0.1)
    end
    ...
    { 4.2 => 16.0,
      ...
      effective_r = HPXMLDefaults.get_default_duct_effective_r_value(nominal_r, HPXML::DuctTypeSupply, HPXML::DuctBuriedInsulationDeep, f_rect_supply)
      assert_in_epsilon(expected_r, effective_r, 0.1)
    end
    ...
    { 4.2 => 22.8,
      ...
      effective_r = HPXMLDefaults.get_default_duct_effective_r_value(nominal_r, HPXML::DuctTypeReturn, HPXML::DuctBuriedInsulationDeep, f_rect_return)
      assert_in_epsilon(expected_r, effective_r, 0.1)
    end
  end
