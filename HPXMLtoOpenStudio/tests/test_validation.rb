...
class HPXMLtoOpenStudioValidationTest < Minitest::Test
  ...
  def test_ruby_warning_messages
    ...
    all_expected_warnings = { 'cfis-undersized-supplemental-fan' => ["CFIS supplemental fan 'VentilationFan2' is undersized (90.0 cfm) compared to the target hourly ventilation rate (110.0 cfm)."],
                              ...
                              'panel-missing-default' => ["PanelLoad/Voltage (240) for 'dishwasher' is not specified in default_panels.csv; PanelLoad/PowerRating will be assigned according to Voltage=120.",
                                                          "PanelLoad/Voltage (240) for 'dishwasher' is not specified in default_panels.csv; PanelLoad/BreakerSpaces will be recalculated using Voltage=240."],
