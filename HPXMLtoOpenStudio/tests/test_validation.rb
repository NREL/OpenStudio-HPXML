  ...
  def test_schema_schematron_warning_messages
    ...
    all_expected_warnings = { 'battery-pv-output-power-low' => ['Max power output should typically be greater than or equal to 500 W.',
                              ...
                              'dhw-efficiencies-low' => ['EnergyFactor should typically be greater than or equal to 0.45.',
                                                         ...
                                                         'EnergyFactor should typically be greater than or equal to 0.45.',
                                                         'No space cooling specified, the model will not include space cooling energy use.'],
                              'dhw-setpoint-low' => ['Hot water setpoint should typically be greater than or equal to 110 F.'],
                              ...
                              'heat-pump-low-backup-switchover-temp' => ['BackupHeatingSwitchoverTemperature is below 30 F; this may result in significant unmet hours if the heat pump does not have sufficient capacity.'],
                              'heat-pump-low-backup-lockout-temp' => ['BackupHeatingLockoutTemperature is below 30 F; this may result in significant unmet hours if the heat pump does not have sufficient capacity.'],
                              ...
                              'hvac-setpoints-high' => ['Heating setpoint should typically be less than or equal to 76 F.',
                                                        'Cooling setpoint should typically be less than or equal to 86 F.'],
                              'hvac-setpoints-low' => ['Heating setpoint should typically be greater than or equal to 58 F.',
                                                       'Cooling setpoint should typically be greater than or equal to 68 F.'],
