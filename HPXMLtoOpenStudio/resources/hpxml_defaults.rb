...
class HPXMLDefaults
  ...
  def self.apply_skylights(hpxml)
    hpxml.skylights.each do |skylight|
      ...
      if skylight.ufactor.nil? || skylight.shgc.nil?
        # Frame/Glass provided instead, fill in more defaults as needed
        if skylight.thermal_break.nil? && [HPXML::WindowFrameTypeAluminum, HPXML::WindowFrameTypeMetal].include? window.frame_type
