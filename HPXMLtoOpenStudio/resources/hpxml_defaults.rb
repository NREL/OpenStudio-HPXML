  ...
  def self.apply_plug_loads(hpxml, cfa, nbeds)
    hpxml.plug_loads.each do |plug_load|
      if plug_load.plug_load_type == HPXML::PlugLoadTypeOther
        ...
        if plug_load.weekday_fractions.nil?
          plug_load.weekday_fractions = '0.037226094, 0.017923965, 0.008702429, 0.007055829, 0.011301553, 0.018088575, 0.029144921, 0.040185268, 0.048956341, 0.058161274, 0.065207292, 0.071970271, 0.075614398, 0.085989906, 0.091350315, 0.102449684, 0.127023227, 0.156153814, 0.210205921, 0.293930994, 0.363415754, 0.34387655, 0.208332122, 0.089930287'
        end
        if plug_load.weekend_fractions.nil?
          plug_load.weekend_fractions = '0.044255876, 0.021666484, 0.011552166, 0.008148614, 0.01103836, 0.013992627, 0.023789881, 0.043384771, 0.071014337, 0.093726393, 0.111924613, 0.123015545, 0.131905894, 0.156318912, 0.178073528, 0.195589338, 0.205776005, 0.212528121, 0.251092958, 0.329719478, 0.387826771, 0.357534539, 0.225776692, 0.10279091'
        end
        if plug_load.monthly_multipliers.nil?
