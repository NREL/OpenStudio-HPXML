...
module Outputs
  ...
  def self.get_panel_results(hpxml_header, hpxml_bldgs)
    ...
    results_out << ['Electric Panel Breaker Spaces: Occupied Count', hpxml_bldgs.map { |hpxml_bldg| hpxml_bldg.electric_panels.map { |electric_panel| ElectricPanel.get_occupied_spaces(electric_panel) }.sum(0.0) * hpxml_bldg.building_construction.number_of_units }.sum(0.0)]
