...
module HVAC
  ...
  def self.set_curves_gshp(heat_pump)
    ...
    cool_eir = (1 - UnitConversions.convert(power_f, 'Wh', 'Btu')) / UnitConversions.convert(heat_pump.cooling_efficiency_eer, 'Btu', 'Wh') - UnitConversions.convert(power_f + power_p, 'Wh', 'Btu')
