...
class HPXML < Object
  ...
  class CeilingFan < BaseElement
    ...
    def to_doc(building)
      ...
      XMLHelper.add_extension(ceiling_fan, 'LabelEnergyUse', @label_energy_use, :float, @label_energy_use_isdefaulted) unless @label_energy_use.nil?
    ...
    def from_doc(ceiling_fan)
      ...
      @label_energy_use = XMLHelper.get_value(ceiling_fan, 'extension/LabelEnergyUse', :float)
