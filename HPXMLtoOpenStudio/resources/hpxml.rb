  ...
  class Header < BaseElement
    ...
    def check_for_errors
      ...
      if not @schedules_filepaths.nil?
        unless File.exist? @schedules_filepaths
          errors << "Schedules file paths '#{@schedules_filepaths}' does not exist."
        end
      end
    ...
    def to_oga(doc)
      ...
      if not @schedules_filepaths.nil?
        extension = XMLHelper.create_elements_as_needed(software_info, ['extension'])
        XMLHelper.add_element(extension, 'SchedulesFilePaths', @schedules_filepaths, :string) unless @schedules_filepaths.nil?
      end
    ...
    def from_oga(hpxml)
      ...
      @schedules_filepaths = XMLHelper.get_value(hpxml, 'SoftwareInfo/extension/SchedulesFilePaths', :string)
