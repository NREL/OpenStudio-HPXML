...
class HPXML < Object
  ...
  class HeatPump < BaseElement
    ...
    def to_oga(doc)
      ...
      XMLHelper.add_extension(heat_pump, 'HeatingCapacityRetentionFraction', @heating_capacity_retention_fraction, :float, @heating_capacity_retention_fraction_isdefaulted) unless @heating_capacity_retention_fraction.nil?
      XMLHelper.add_extension(heat_pump, 'HeatingCapacityRetentionTemperature', @heating_capacity_retention_temp, :float, @heating_capacity_retention_temp_isdefaulted) unless @heating_capacity_retention_temp.nil?
    ...
    def from_oga(heat_pump)
      ...
      @heating_capacity_retention_fraction = XMLHelper.get_value(heat_pump, 'extension/HeatingCapacityRetentionFraction', :float)
      @heating_capacity_retention_temp = XMLHelper.get_value(heat_pump, 'extension/HeatingCapacityRetentionTemperature', :float)
