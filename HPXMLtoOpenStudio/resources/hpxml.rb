...
class HPXML < Object
  ...
  HVACTypeIntegratedHeating = 'integrated heating'
  ...
  class CoolingSystem < BaseElement
    ATTRS = [:id, :distribution_system_idref, :year_installed, :cooling_system_type, :cooling_system_fuel,
             ...
             :integrated_heating_system_capacity, :integrated_heating_system_efficiency, :integrated_heating_system_fraction_heat_load_served,
    ...
    def has_integrated_heating
      ...
      return false if @integrated_heating_system_fraction_heat_load_served.nil?
    ...
    def to_oga(doc)
      ...
      XMLHelper.add_element(cooling_system, 'IntegratedHeatingSystemCapacity', @integrated_heating_system_capacity, :float) unless @integrated_heating_system_capacity.nil?
      if not @integrated_heating_system_efficiency.nil?
        annual_efficiency = XMLHelper.add_element(cooling_system, 'IntegratedHeatingSystemAnnualEfficiency')
        XMLHelper.add_element(annual_efficiency, 'Units', UnitsPercent, :string)
        XMLHelper.add_element(annual_efficiency, 'Value', @integrated_heating_system_efficiency, :float, @integrated_heating_system_efficiency_isdefaulted)
      end
      ...
      XMLHelper.add_extension(cooling_system, 'IntegratedHeatingSystemAirflowCFM', @integrated_heating_system_airflow_cfm, :float, @integrated_heating_system_airflow_cfm_isdefaulted) unless @integrated_heating_system_airflow_cfm.nil?
    ...
    def from_oga(cooling_system)
      ...
      @integrated_heating_system_efficiency = XMLHelper.get_value(cooling_system, "IntegratedHeatingSystemAnnualEfficiency[Units='#{UnitsPercent}']/Value", :float)
      ...
      @integrated_heating_system_airflow_cfm = XMLHelper.get_value(cooling_system, 'extension/IntegratedHeatingSystemAirflowCFM', :float)
