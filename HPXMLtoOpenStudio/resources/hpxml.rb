...
class HPXML < Object
  ...
  class CeilingFan < BaseElement
    ATTRS = [:id, :efficiency, :label_average_energy_use, :count, :weekday_fractions, :weekend_fractions, :monthly_multipliers]
    attr_accessor(*ATTRS)
    ...
    def to_doc(building)
      ...
      XMLHelper.add_extension(ceiling_fan, 'LabelAverageEnergyUse', @label_average_energy_use, :float, @label_average_energy_use_isdefaulted) unless @label_average_energy_use.nil?
    ...
    def from_doc(ceiling_fan)
      ...
      @label_average_energy_use = XMLHelper.get_value(ceiling_fan, 'extension/LabelAverageEnergyUse', :float)
