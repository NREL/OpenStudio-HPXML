...
class HPXML < Object
  ...
  class Window < BaseElement
    ATTRS = [:id, :area, :azimuth, :orientation, :frame_type, :thermal_break, :glass_layers,
             ...
             :exterior_shading_factor_winter, :exterior_shading_type, :window_storm_type, :overhangs_depth,
    ...
    def to_oga(doc)
      ...
      if not @window_storm_type.nil?
        ...
        XMLHelper.add_element(storm_window, 'GlassType', @window_storm_type, :string) unless @window_storm_type.nil?
      end
    ...
    def from_oga(window)
      ...
      @window_storm_type = XMLHelper.get_value(window, 'StormWindow/GlassType', :string)
    end
  end
  ...
  class Skylight < BaseElement
    ATTRS = [:id, :area, :azimuth, :orientation, :frame_type, :thermal_break, :glass_layers,
             :glass_type, :gas_fill, :ufactor, :shgc, :interior_shading_factor_summer,
             :interior_shading_factor_winter, :interior_shading_type, :exterior_shading_factor_summer,
             :exterior_shading_factor_winter, :exterior_shading_type, :skylight_storm_type, :roof_idref]
    attr_accessor(*ATTRS)
    ...
    def to_oga(doc)
      ...
      if not @skylight_storm_type.nil?
        storm_window = XMLHelper.add_element(skylight, 'StormWindow')
        sys_id = XMLHelper.add_element(storm_window, 'SystemIdentifier')
        XMLHelper.add_attribute(sys_id, 'id', "#{id}StormWindow")
        XMLHelper.add_element(storm_window, 'GlassType', @skylight_storm_type, :string) unless @skylight_storm_type.nil?
      end
    ...
    def from_oga(skylight)
      ...
      @skylight_storm_type = XMLHelper.get_value(skylight, 'StormWindow/GlassType', :string)
    end
  end
