...
class Constructions
  ...
  def self.get_default_window_skylight_ufactor_shgc(window_or_skylight, type)
    ...
    # Lookup values from Home Energy Score
    key = [is_metal_frame, window_or_skylight.thermal_break, n_panes, glass_type, gas_fill]
    if type.downcase == 'window'
      vals = { [true, false, 1, 'clear', nil] => [1.27, 0.75], # Single-pane, clear, aluminum frame
               [false, nil, 1, 'clear', nil] => [0.89, 0.64], # Single-pane, clear, wood or vinyl frame
               [true, false, 1, 'tinted', nil] => [1.27, 0.64], # Single-pane, tinted, aluminum frame
               [false, nil, 1, 'tinted', nil] => [0.89, 0.54], # Single-pane, tinted, wood or vinyl frame
      ...
      vals = { [true, false, 1, 'clear', nil] => [1.98, 0.75], # Single-pane, clear, aluminum frame
               [false, nil, 1, 'clear', nil] => [1.47, 0.64], # Single-pane, clear, wood or vinyl frame
               [true, false, 1, 'tinted', nil] => [1.98, 0.64], # Single-pane, tinted, aluminum frame
               [false, nil, 1, 'tinted', nil] => [1.47, 0.54], # Single-pane, tinted, wood or vinyl frame
