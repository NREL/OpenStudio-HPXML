...
class Airflow
  ...
  def self.calculate_precond_loads(model, infil_program, vent_mech_preheat, vent_mech_precool, hrv_erv_effectiveness_map, fan_sens_load_actuator, fan_lat_load_actuator, clg_ssn_sensor)
    ...
    vent_mech_preheat.each_with_index do |f_preheat, i|
      ...
      cnt = model.getOtherEquipments.select { |oe| oe.endUseSubcategory.start_with? Constants.ObjectNameMechanicalVentilationPreheating }.size # Ensure unique meter for each preheating system
    ...
    vent_mech_precool.each_with_index do |f_precool, i|
      ...
      cnt = model.getOtherEquipments.select { |oe| oe.endUseSubcategory.start_with? Constants.ObjectNameMechanicalVentilationPrecooling }.size # Ensure unique meter for each precooling system
