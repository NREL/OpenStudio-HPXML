  ...
  def self.add_hot_water_and_appliances(runner, model, weather, spaces)
    ...
    @hpxml.water_heating_systems.each do |water_heating_system|
      ...
      if water_heating_system.water_heater_type == HPXML::WaterHeaterTypeStorage
        plantloop_map[sys_id] = Waterheater.apply_tank(model, runner, loc_space, loc_schedule, water_heating_system, ec_adj, solar_thermal_system, @schedules_file)
      elsif water_heating_system.water_heater_type == HPXML::WaterHeaterTypeTankless
        plantloop_map[sys_id] = Waterheater.apply_tankless(model, runner, loc_space, loc_schedule, water_heating_system, ec_adj, @nbeds, solar_thermal_system, @schedules_file)
      elsif water_heating_system.water_heater_type == HPXML::WaterHeaterTypeHeatPump
        living_zone = spaces[HPXML::LocationLivingSpace].thermalZone.get
        plantloop_map[sys_id] = Waterheater.apply_heatpump(model, runner, loc_space, loc_schedule, weather, water_heating_system, ec_adj, solar_thermal_system, living_zone, @schedules_file)
        ...
        plantloop_map[sys_id] = Waterheater.apply_combi(model, runner, loc_space, loc_schedule, water_heating_system, ec_adj, solar_thermal_system, @schedules_file)
      else
