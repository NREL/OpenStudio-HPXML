...
class OSModel
  ...
  def self.add_foundation_walls_slabs(runner, model, weather, spaces)
    ...
    foundation_types.each do |foundation_type|
      ...
      # Slab and exterior foundation wall surfaces
      slabs.each do |slab|
        ...
        if ext_fnd_walls.empty?
          ...
          ext_fnd_walls.each do |fnd_wall|
            ...
            fnd_wall.depth_below_grade = slab.depth_below_grade
  ...
  def self.add_foundation_slab(model, weather, spaces, slab, exposed_length, kiva_foundation)
