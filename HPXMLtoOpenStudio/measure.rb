...
class OSModel
  ...
  def self.set_surface_exterior(model, spaces, surface, hpxml_surface)
    ...
    if exterior_adjacent_to == HPXML::LocationOutside
      ...
      surface.setOutsideBoundaryCondition('Foundation')
    elsif (exterior_adjacent_to == HPXML::LocationOtherHousingUnit && [HPXML::LocationLivingSpace, HPXML::LocationBasementConditioned].include?(interior_adjacent_to)) || is_adiabatic
