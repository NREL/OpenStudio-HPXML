...
class ScheduleGenerator
  ...
  def create_stochastic_schedules(args:)
    ...
    for _i in 1..args[:geometry_num_occupants]
      ...
      @total_days_in_year.times do |day|
        ...
        while j < @mkc_ts_per_day do
          ...
          activity_duration.times do |_repeat_activity_count|
    ...
    @total_days_in_year.times do |day|
      cluster_per_day.times do |_cluster_count|
        ...
        num_events.times do |_event_count|
    ...
    while step < mkc_steps_in_a_year
      ...
      step_jump = 1
      if shower_state > 0
        shower_state.to_i.times do |_occupant_number|
          r = prng.rand
          if r <= bath_ratio
