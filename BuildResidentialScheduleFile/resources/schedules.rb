...
class ScheduleGenerator
  ...
  def create_stochastic_schedules(args:,
    ...
    ceiling_fan_monthly_multiplier = Schedule.validate_values(HPXMLDefaults.get_default_ceiling_fan_months(weather).join(', '), 12, 'monthly') # based on monthly average outdoor temperatures per ANSI/RESNET/ICC 301-2019
