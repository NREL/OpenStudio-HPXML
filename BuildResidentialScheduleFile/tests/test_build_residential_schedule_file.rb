...
class BuildResidentialScheduleFileTest < Minitest::Test
  ...
  def test_stochastic
    ...
    assert_in_epsilon(6773, sf.annual_equivalent_full_load_hrs(col_name: SchedulesFile::Columns[:PlugLoadsOther].name, schedules: sf.tmp_schedules), @tol)
    assert_in_epsilon(1820, sf.annual_equivalent_full_load_hrs(col_name: SchedulesFile::Columns[:PlugLoadsTV].name, schedules: sf.tmp_schedules), @tol)
  ...
  def test_random_seed
    ...
    assert_in_epsilon(6654, sf.annual_equivalent_full_load_hrs(col_name: SchedulesFile::Columns[:PlugLoadsOther].name, schedules: sf.tmp_schedules), @tol)
    assert_in_epsilon(1466, sf.annual_equivalent_full_load_hrs(col_name: SchedulesFile::Columns[:PlugLoadsTV].name, schedules: sf.tmp_schedules), @tol)
  ...
  def test_10_min_timestep
    ...
    assert_in_epsilon(6779, sf.annual_equivalent_full_load_hrs(col_name: SchedulesFile::Columns[:PlugLoadsOther].name, schedules: sf.tmp_schedules), @tol)
    assert_in_epsilon(1806, sf.annual_equivalent_full_load_hrs(col_name: SchedulesFile::Columns[:PlugLoadsTV].name, schedules: sf.tmp_schedules), @tol)
  ...
  def test_multiple_buildings
    ...
    hpxml.buildings.each do |hpxml_bldg|
      ...
      if hpxml_bldg.building_id == 'MyBuilding'
        ...
        assert_in_epsilon(6627, sf.annual_equivalent_full_load_hrs(col_name: SchedulesFile::Columns[:PlugLoadsOther].name, schedules: sf.tmp_schedules), @tol)
        assert_in_epsilon(1408, sf.annual_equivalent_full_load_hrs(col_name: SchedulesFile::Columns[:PlugLoadsTV].name, schedules: sf.tmp_schedules), @tol)
