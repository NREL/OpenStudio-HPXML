...
class BuildResidentialScheduleFileTest < Minitest::Test
  ...
  def test_smooth
    ...
    assert_in_epsilon(150, sf.annual_equivalent_full_load_hrs(col_name: ScheduleScheduleColumns.LightingExteriorHoliday, schedules: sf.tmp_schedules), 0.1)
  ...
  def test_smooth_vacancy
    ...
    assert_in_epsilon(19, sf.annual_equivalent_full_load_hrs(col_name: ScheduleScheduleColumns.LightingExteriorHoliday, schedules: sf.tmp_schedules), 0.1)
  ...
  def test_stochastic_vacancy
    ...
    assert_in_epsilon(11, sf.annual_equivalent_full_load_hrs(col_name: ScheduleScheduleColumns.LightingExteriorHoliday, schedules: sf.tmp_schedules), 0.1)
  ...
  def test_AMY_2012_vacancy
    ...
    assert_in_epsilon(0, sf.annual_equivalent_full_load_hrs(col_name: ScheduleScheduleColumns.LightingExteriorHoliday, schedules: sf.tmp_schedules), 0.1)
