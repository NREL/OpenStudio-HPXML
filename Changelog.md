...
- Adds capability to model variable speed system power shedding controls in response to commands in the AHRI 1380 standard with maximum power ratio schedule
