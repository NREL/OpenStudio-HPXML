...
- New heat pump capabilities:
  ...
  - Allows `BackupHeatingLockoutTemperature` as an optional input to control backup heating availability during, e.g., a thermostat heating setback recovery event; defaults to 40F.
