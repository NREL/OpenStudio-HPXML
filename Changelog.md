...
- BuildResidentialHPXML measure:
  ...
  - **Breaking change**: Replaces `schedules_vacancy_period` argument with `schedules_vacancy_periods`, `schedules_power_outage_period` with `schedules_power_outage_periods`, and `schedules_power_outage_window_natvent_availability` with `schedules_power_outage_periods_window_natvent_availability` (arguments now support defining multiple unavailable periods).
