...
__New Features__
- **Breaking change**: Changes the BuildResidentialHPXML measure's zip code argument to `site_zip_code`.
...
__Bugfixes__
- Perform defaulting of state code and zip code in `hpxml_defaults.rb` instead of the BuildResidentialHPXML measure.
