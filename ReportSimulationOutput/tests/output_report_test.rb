...
class ReportSimulationOutputTest < MiniTest::Test
  ...
  BaseHPXMLTimeseriesColsAdvancedOutputVariables = [
    ...
    'Surface Construction Index: Inferred Ceiling Above Basement - Conditioned',
    'Surface Construction Index: Inferred Floor Above Basement - Conditioned',
    'Surface Construction Index: Partition Wall Mass Basement - Conditioned',
    'Surface Construction Index: Partition Wall Mass Living Space 1',
