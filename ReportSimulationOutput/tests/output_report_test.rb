...
class ReportSimulationOutputTest < MiniTest::Test
  ...
  AnnualRows = [
    ...
    'HVAC Design Loads Heating: Total (Btu/h)',
    'HVAC Design Loads Heating: Ducts (Btu/h)',
    'HVAC Design Loads Heating: Windows (Btu/h)',
    'HVAC Design Loads Heating: Skylights (Btu/h)',
    'HVAC Design Loads Heating: Doors (Btu/h)',
    'HVAC Design Loads Heating: Walls (Btu/h)',
    'HVAC Design Loads Heating: Roofs (Btu/h)',
    'HVAC Design Loads Heating: Floors (Btu/h)',
    'HVAC Design Loads Heating: Slabs (Btu/h)',
    'HVAC Design Loads Heating: Ceilings (Btu/h)',
    'HVAC Design Loads Heating: Infiltration/Ventilation (Btu/h)',
    'HVAC Design Loads Cooling Sensible: Total (Btu/h)',
    'HVAC Design Loads Cooling Sensible: Ducts (Btu/h)',
    'HVAC Design Loads Cooling Sensible: Windows (Btu/h)',
    'HVAC Design Loads Cooling Sensible: Skylights (Btu/h)',
    'HVAC Design Loads Cooling Sensible: Doors (Btu/h)',
    'HVAC Design Loads Cooling Sensible: Walls (Btu/h)',
    'HVAC Design Loads Cooling Sensible: Roofs (Btu/h)',
    'HVAC Design Loads Cooling Sensible: Floors (Btu/h)',
    'HVAC Design Loads Cooling Sensible: Slabs (Btu/h)',
    'HVAC Design Loads Cooling Sensible: Ceilings (Btu/h)',
    'HVAC Design Loads Cooling Sensible: Infiltration/Ventilation (Btu/h)',
    'HVAC Design Loads Cooling Sensible: Internal Gains (Btu/h)',
    'HVAC Design Loads Cooling Latent: Total (Btu/h)',
    'HVAC Design Loads Cooling Latent: Ducts (Btu/h)',
    'HVAC Design Loads Cooling Latent: Infiltration/Ventilation (Btu/h)',
    'HVAC Design Loads Cooling Latent: Internal Gains (Btu/h)'
  ]
