...
class ReportSimulationOutputTest < Minitest::Test
  ...
  def test_electric_panel
    ...
    assert_equal(47457.7, actual_panel_rows['Electric Panel Load: 2023 Existing Dwelling Meter-Based: Total Load (W)'])
    assert_equal(197.7, actual_panel_rows['Electric Panel Load: 2023 Existing Dwelling Meter-Based: Total Capacity (A)'])
    assert_in_epsilon(100.0 - 197.7, actual_panel_rows['Electric Panel Load: 2023 Existing Dwelling Meter-Based: Headroom Capacity (A)'], 0.01)
