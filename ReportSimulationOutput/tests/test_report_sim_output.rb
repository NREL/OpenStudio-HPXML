...
class ReportSimulationOutputTest < Minitest::Test
  ...
  def test_electric_panel
    ...
    assert_equal(9909.2, actual_panel_rows['Electric Panel Demand Load Capacity: 2023 Load-Based: Total (W)'])
    assert_equal(41.0, actual_panel_rows['Electric Panel Demand Load Capacity: 2023 Load-Based: Total (A)'])
    assert_equal(100.0 - 41.0, actual_panel_rows['Electric Panel Demand Load Capacity: 2023 Load-Based: Headroom (A)'])
    assert_equal(2581.8, actual_panel_rows['Electric Panel Demand Load Capacity: 2023 Meter-Based: Total (W)'])
    assert_equal(10.8, actual_panel_rows['Electric Panel Demand Load Capacity: 2023 Meter-Based: Total (A)'])
    assert_equal(100.0 - 10.8, actual_panel_rows['Electric Panel Demand Load Capacity: 2023 Meter-Based: Headroom (A)'])
    assert_equal(13, actual_panel_rows['Electric Panel Demand Load Occupied Spaces: Total Count'])
    assert_equal(8, actual_panel_rows['Electric Panel Demand Load Occupied Spaces: Occupied Count'])
    assert_equal(13 - 8, actual_panel_rows['Electric Panel Demand Load Occupied Spaces: Headroom Count'])
    ...
    assert(File.exist?(panel_csv))
    actual_panel_rows = _get_annual_values(panel_csv)
    assert_equal(35827.2, actual_panel_rows['Electric Panel Demand Load Capacity: 2023 Load-Based: Total (W)'])
    assert_equal(149.0, actual_panel_rows['Electric Panel Demand Load Capacity: 2023 Load-Based: Total (A)'])
    assert_equal(100.0 - 149.0, actual_panel_rows['Electric Panel Demand Load Capacity: 2023 Load-Based: Headroom (A)'])
    assert_equal(44671.6, actual_panel_rows['Electric Panel Demand Load Capacity: 2023 Meter-Based: Total (W)'])
    assert_equal(186.1, actual_panel_rows['Electric Panel Demand Load Capacity: 2023 Meter-Based: Total (A)'])
    assert_equal(100.0 - 186.1, actual_panel_rows['Electric Panel Demand Load Capacity: 2023 Meter-Based: Headroom (A)'])
    assert_equal(12, actual_panel_rows['Electric Panel Demand Load Occupied Spaces: Total Count'])
    assert_equal(17, actual_panel_rows['Electric Panel Demand Load Occupied Spaces: Occupied Count'])
    assert_equal(12 - 17, actual_panel_rows['Electric Panel Demand Load Occupied Spaces: Headroom Count'])
  end
